...
class CTexEdit
{
  ...
  public:
    ...
    //////////////////////////////////////////////////////////////////////////////
    void DoModal(CAnim3D *panim,         // In:  3D animation to paint on.
    ...
    //////////////////////////////////////////////////////////////////////////////
    void DoOutput(CSprite3 *psprite,   // In:  3D data to render.
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void ProcessManip(bool bButtonDown,  // In:  true if mouse button down.
  ...
  protected:
    ...
    //////////////////////////////////////////////////////////////////////////////
    void SetManip(Manip manip) // In:  New manipulation type.
      ;

    //////////////////////////////////////////////////////////////////////////////
    // Set the current palette color.
    //////////////////////////////////////////////////////////////////////////////
    void SetColor(U8 u8Color) // In:  New color index.
      ;

    //////////////////////////////////////////////////////////////////////////////
    // Set the specified button to notify.
    //////////////////////////////////////////////////////////////////////////////
    void SetToNotify(long lBtnId,             // In:  ID of btn whose callback will be set.
    ...
    //////////////////////////////////////////////////////////////////////////////
    void SetToNotify(long lId,                     // In:  ID of gui whose callback will be set.
    ...
    //////////////////////////////////////////////////////////////////////////////
    void SetToNotify(long lId,                      // In:  ID of scrollbar whose callback will be set.
    ...
    //////////////////////////////////////////////////////////////////////////////
    void SetStatusText(const char *pszFrmt, // In:  Format specifier ala sprintf.
    ...
    //////////////////////////////////////////////////////////////////////////////
    void ComposeTransform(RTransform &trans) // In:  Transform to compose in.
      ;
