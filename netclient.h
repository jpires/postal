...
class CNetClient
{
  ...
  public:
    ...
    // Startup
    ////////////////////////////////////////////////////////////////////////////////
    void Startup(RSocket::BLOCK_CALLBACK callback); // In:  Blocking callback
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void SendChat(const char *pszText); // In:  Text to send

    ////////////////////////////////////////////////////////////////////////////////
    // Send text message (text is send as is)
    ////////////////////////////////////////////////////////////////////////////////
    void SendText(const char *pszText); // In:  Text to send

    ////////////////////////////////////////////////////////////////////////////////
    // Send realm status
    ////////////////////////////////////////////////////////////////////////////////
    void SendRealmStatus(bool bReady);
    ...
    ////////////////////////////////////////////////////////////////////////////////
    bool IsMoreToSend(void) { return m_msgr.IsMoreToSend(); }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    short GetNumPlayers(void) { return m_sNumJoined; }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    unsigned char GetPlayerColor(Net::ID id)
    {
        ASSERT(id != Net::InvalidID);
        ASSERT(id < Net::MaxNumIDs);
    ...
    ////////////////////////////////////////////////////////////////////////////////
    bool DoesPlayerNeedDude(Net::ID id)
    {
    ...
    void SetPlayerDudeID(Net::ID id, U16 idDude)
    {
        ASSERT(id != Net::InvalidID);
        ASSERT(id < Net::MaxNumIDs);
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void SetLocalInput(UINPUT input);

    ////////////////////////////////////////////////////////////////////////////////
    // Get the input seq that has NOT been sent yet to any other player
    ////////////////////////////////////////////////////////////////////////////////
    Net::SEQ GetInputSeqNotYetSent(void) { return m_seqInputNotYetSent; }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void SetHaltFrame(Net::SEQ seqHalt);
