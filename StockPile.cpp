...
////////////////////////////////////////////////////////////////////////////////
inline void CheckMultiBtn( // Returns nothing.
  RGuiItem *pguiRoot,      // In:  Root GUI.
  long lId,                // In:  ID of GUI to set text.
...
////////////////////////////////////////////////////////////////////////////////
inline short IsMultiBtnChecked( // Returns multibtn's state.
  RGuiItem *pguiRoot,           // In:  Root GUI.
  long lId)                     // In:  ID of GUI to set text.
{
    short sRes = 0; // Assume nothing;
    ...
    if (pgui)
    {
        ...
        if (pguiChild)
        {
                  ...
                  pgui->m_im.m_sDepth) == 0)
            {
                ...
                pguiChild->Move(pgui->m_im.m_sWidth / 2 - pguiChild->m_im.m_sWidth / 2, sChildPosY);
                ...
                RSP_SAFE_GUI_REF_VOID(pguiCancel,
                                      Move(pguiCancel->m_sX, pguiCancel->m_sY + (pgui->m_im.m_sHeight - sOldHeight)));
            }
            else
            {
