...
static void Remap(unsigned char *aucMap);

////////////////////////////////////////////////////////////////////////////////
// Call this to start the menu transition effect
////////////////////////////////////////////////////////////////////////////////
extern void StartMenuTrans(long lTotalTime) // In:  Effect time (in ms) must be >= 0
{
...
extern bool DoPreMenuTrans()
{
    ...
    else if (m_sStep == 2)
    {
        ...
        rspSetPaletteEntries(EFFECT_BEG,
                             EFFECT_LEN,
                             &(m_pWork[EFFECT_BEG].r),
                             &(m_pWork[EFFECT_BEG].g),
                             &(m_pWork[EFFECT_BEG].b),
                             sizeof(rgb));
        rspUpdatePalette();
    ...
    else if (m_sStep == 4)
    {
        ...
        rspSetPaletteEntries(NONSHADE_BEG,
                             NONSHADE_LEN,
                             &(m_pWork[NONSHADE_BEG].r),
                             &(m_pWork[NONSHADE_BEG].g),
                             &(m_pWork[NONSHADE_BEG].b),
                             sizeof(rgb));
        rspUpdatePalette();
...
//
////////////////////////////////////////////////////////////////////////////////
extern void EndMenuTrans(bool bFinish) // In: true to finish effect, false to abort it
{
