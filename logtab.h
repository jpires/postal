...
class CLogTabVar
{
  ...
  public:
    ...
    ~CLogTabVar()
    {
        ...
        {
            TRACE(
              "CLogTabVar::~CLogTabVar(): Destroying '%s', which is still being used by CLogTab(s) (refcount = %hd)!\n",
              m_pszName,
              (short)m_sRefCount);
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static short FindVar(  // Returns 0 if successfull, non-zero otherwise
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void IncRefCount(void) { m_sRefCount++; }

    ////////////////////////////////////////////////////////////////////////////////
    // Decrement reference count
    ////////////////////////////////////////////////////////////////////////////////
    void DecRefCount(void) { m_sRefCount--; }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual void SetVal(usertype user, // In:  User type passed here
...
class CLogTab
{
  ...
  private:
    ...
    // (See .cpp for details)
    ////////////////////////////////////////////////////////////////////////////////
    short ReadEntry(RFile *pFile,        // In:  RFile to read from
...
////////////////////////////////////////////////////////////////////////////////
template<class usertype>
short CLogTab<usertype>::Evaluate(usertype user, // In:  User type passed here
                                  bool bLog)     // In:  Whether to log (true) or not (false)
{
    short sResult = 0;
            ...
            else
            {
                ...
                if (m_sTotalVars < MaxVars)
                {
                    ...
                    else
                    {
                        ...
                        rspMsgBox(LOGTAB_MSG,
                                  "Variable named '%s' does not exist or is defined multiple times.  Either way, you "
                                  "are hosed.",
                                  acText);
                    }
                }
