...
class CPlayInfo
{
  ...
  public:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void SetFrameTime(short sFrameTime) { m_sFrameTime = sFrameTime; }
    ...
    void SetGameState_NextRealm(bool bServerToldMe = false) { m_gamestate = Game_NextRealm; }

    void SetGameState_GameOver(bool bServerToldMe = false)
    {
        // This should NEVER occur in MP mode
    ...
    void SetGameState_GameAborted(bool bServerToldMe = false) { m_gamestate = Game_GameAborted; }
...
class CPlay
{
  ...
  public:
    ...
    // Prepare game
    ////////////////////////////////////////////////////////////////////////////////
    virtual short PrepareGame( // Returns 0 if successfull, non-zero otherwise
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual short IsGameReady( // Returns 0 if successfull, non-zero otherwise
      CPlayInfo *pinfo,        // I/O: Play info
    ...
    // Start game
    ////////////////////////////////////////////////////////////////////////////////
    virtual short StartGame( // Returns 0 if successfull, non-zero otherwise
      CPlayInfo *pinfo)      // I/O: Play info
    {
        return 0;
    }
    ...
    // Start cutscene
    ////////////////////////////////////////////////////////////////////////////////
    virtual void StartCutscene(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    // Prepare realm
    ////////////////////////////////////////////////////////////////////////////////
    virtual short PrepareRealm( // Returns 0 if successfull, non-zero otherwise
      CPlayInfo *pinfo)         // I/O: Play info
    {
        return 0;
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual short IsRealmReady( // Returns 0 if successfull, non-zero otherwise
      CPlayInfo *pinfo,         // I/O: Play info
    ...
    // Do cutscene
    ////////////////////////////////////////////////////////////////////////////////
    virtual void DoCutscene(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    // End cutscene
    ////////////////////////////////////////////////////////////////////////////////
    virtual void EndCutscene(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    // Core loop update
    ////////////////////////////////////////////////////////////////////////////////
    virtual void CoreLoopUpdate(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual void CoreLoopRender(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual bool IsCoreLoopDone( // Returns true if done, false otherwise
      CPlayInfo *pinfo)          // I/O: Play info
    {
    ...
    // End realm
    ////////////////////////////////////////////////////////////////////////////////
    virtual void EndRealm(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual void StartRealmErr(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual void IsRealmReadyErr(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual void PrepareRealmErr(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual void StartGameErr(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual void IsGameReadyErr(CPlayInfo *pinfo) // I/O: Play info
    {
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    virtual void PrepareGameErr(CPlayInfo *pinfo) // I/O: Play info
    {
    }
};
...
class CPlayGroup
{
  ...
  public:
    ...
    // Destructor
    ////////////////////////////////////////////////////////////////////////////////
    ~CPlayGroup() { m_Plays.Reset(); }

    ////////////////////////////////////////////////////////////////////////////////
    // Add a module
    ////////////////////////////////////////////////////////////////////////////////
    void AddModule(CPlay *pPlay) { m_Plays.InsertHead(pPlay); }

    ////////////////////////////////////////////////////////////////////////////////
    // Remove a module
    ////////////////////////////////////////////////////////////////////////////////
    void RemoveModule(CPlay *pPlay)
    {
...
class CPlayNet : public CPlay
{
  ...
  public:
    ...
    CPlayNet(void)
    {
        ...
        for (sIndex = 0; sIndex < NUM_CHATS; sIndex++)
        {
            ...
            if (m_apeditChats[sIndex])
            {
                ...
                if (m_apeditChats[sIndex]->Create(REALM_STATUS_RECT_X,
                                                  REALM_STATUS_RECT_Y + REALM_STATUS_RECT_H +
                                                    (m_apeditChats[sIndex]->m_im.m_sHeight * sIndex),
                                                  REALM_STATUS_RECT_W,
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void MoveChatsUp(CPlayInfo *pinfo) // In:  Info object.
    {
        short sIndex = 0;
        ...
        while (sIndex < NUM_CHATS)
        {
            ...
            {
                m_apeditChats[sIndex]->SetText("%s",
                                               (sIndex >= NUM_CHATS - 1) ? "" : m_apeditChats[sIndex + 1]->m_szText);
                ...
                if (m_apeditChats[sIndex]->m_szText[0] == '\0')
                {
                    ...
                    if (pinfo->Camera()->m_sFilmViewX > 0)
                    {
                        ...
                        pinfo->m_drl.Add(m_apeditChats[sIndex]->m_sX,
                                         m_apeditChats[sIndex]->m_sY,
                                         m_apeditChats[sIndex]->m_im.m_sWidth,
                                         m_apeditChats[sIndex]->m_im.m_sHeight);
                    }
    ...
    // Draw visible chats.
    ////////////////////////////////////////////////////////////////////////////////
    void DrawChats(CPlayInfo *pinfo) // In:  Info object.
    {
        short sIndex;
        for (sIndex = 0; sIndex < NUM_CHATS; sIndex++)
        {
      ...
      CPlayInfo *pinfo)       // I/O: Play info
    {
        if (pinfo->IsMP())
        {
            ...
            if (ptxt)
            {
                ptxt->SetText("Waiting for other\n"
                              "players to get ready...");
                ptxt->Compose();
                ptxt->Move((g_pimScreenBuf->m_sWidth / 2) - (ptxt->m_im.m_sWidth / 2),
  ...
  public:
      ...
      CPlayInfo *pinfo) // I/O: Play info
    {
        if (!pinfo->m_bBadRealmMP)
        {
            ...
            if (!g_bLastLevelDemo)
            {
                ToolBarRender(pinfo->Realm()->m_phood,
                              g_pimScreenBuf,
                              m_rectDude.sX,
                              m_rectDude.sY,
                              pinfo->LocalDudePointer(),
                              TRUE);
                ...
                rspBlit(pinfo->Realm()->m_phood->m_pimTopBar,
                        g_pimScreenBuf,
                        0,
                        0,
                        REALM_STATUS_RECT_X,
            ...
            rspUpdateDisplay(REALM_STATUS_RECT_X,
                             REALM_STATUS_RECT_Y,
                             pinfo->Realm()->m_phood->m_pimTopBar->m_sWidth,
                             pinfo->Realm()->m_phood->m_pimTopBar->m_sHeight);
        }
        ...
        if (!pinfo->m_bBadRealmMP)
        {
            ...
            if (pinfo->IsMP())
            {
                ...
                if (m_seqCurrFrameSeq != m_seqPrevFrameSeq)
                {
                    ...
                    m_lFramePerSecond = 1000.0 * (m_seqCurrFrameSeq - m_seqPrevFrameSeq) /
                                        (lCurrSeqTime - m_lPrevSeqTime);
            ...
            if (!pinfo->m_bInMenu)
            {
                ...
                if (pinfo->m_bDrawFrame)
                {
                    ...
                    if (!g_bLastLevelDemo)
                    {
                        ...
                        bUpdateRealm = ScoreUpdateDisplay(g_pimScreenBuf,
                                                          &m_rectRealm,
                                                          pinfo->Realm(),
                                                          pinfo->Client(),
                                                          REALM_STATUS_RECT_X,
                        ...
                        // Generate TooL Bar
                        if (ToolBarRender(pinfo->Realm()->m_phood,
                                          g_pimScreenBuf,
                                          m_rectDude.sX,
                                          m_rectDude.sY,
  ...
  public:
    ...
    CPlayInput(void)
    {
        ...
        if (m_peditChatIn)
        {
            ...
            // Recreate in the correct spot and dimensions . . .
            if (m_peditChatIn->Create(DUDE_STATUS_RECT_X,
...
// If sales demo cheat is enabled, we can go to the next level
                                ...
                                switch (pie->lKey)
                                {
                                    ...
                                    case KEY_ABORT_CHAT: // Cancel jumps in here to clean up but not send anything.
                                        ...
                                        if (pinfo->Camera()->m_sFilmViewX > 0)
                                        {
                                            ...
                                            // Add dirty rectangle to update erased area.
                                            pinfo->m_drl.Add(m_peditChatIn->m_sX,
                                                             m_peditChatIn->m_sY,
                                                             m_peditChatIn->m_im.m_sWidth,
                                                             m_peditChatIn->m_im.m_sHeight);
                                        }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void PauseGame(CRealm *prealm, // In:  Realm to pause or NULL.
                   ...
                   long lKey)      // In:  Key to continue or 0 to wait for foreground status
    {
        ...
        // 'PAUSED' fore color.
        rspSetPaletteEntry(PAUSED_BASE_PAL_INDEX + 0, // Palette entry (0 to 255)
        ...
        // 'PAUSED' shadow color.
        rspSetPaletteEntry(PAUSED_BASE_PAL_INDEX + 1,   // Palette entry (0 to 255)
        ...
        // Message fore color.
        rspSetPaletteEntry(PAUSED_BASE_PAL_INDEX + 2, // Palette entry (0 to 255)
        ...
        rspSetPaletteEntry(PAUSED_BASE_PAL_INDEX + 3,       // Palette entry (0 to 255)
        ...
        print.SetColor(PAUSED_BASE_PAL_INDEX + 0, 0, PAUSED_BASE_PAL_INDEX + 1);
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void StartMenu(CPlayInfo *pinfo) // I/O: Play info
    {
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void DoMenu(CPlayInfo *pinfo, // I/O: Play info
                RInputEvent *pie) // I/O: Input event
    {
...
#error You need to switch over from this code to the in-game file UI first.
                ...
                if (sResult == 0)
                {
                    if (Game_SavePlayersGame(szFile, pinfo->Realm()->m_flags.sDifficulty) != SUCCESS)
                    {
                        rspMsgBox(RSP_MB_ICN_EXCLAIM | RSP_MB_BUT_OK, g_pszSaveGameErrorTitle, g_pszSaveGameErrorText);
                    }
                }
#endif
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void StopMenu(CPlayInfo *pinfo) // I/O: Play info
    {
        // End the menu
        ::StopMenu();
        ...
        pinfo->Camera()->SetViewSize(VIEW_W * g_GameSettings.m_dGameFilmScale,
...
// to a user of a normal version, so we don't say anything.
                ...
                if (!pinfo->IsMP())
                {
                    rspMsgBox(RSP_MB_ICN_INFO | RSP_MB_BUT_OK, g_pszAppName, g_pszPlayOneRealmOnlyMessage);
                }
        ...
        if (!pinfo->m_bBadRealmMP)
        {
            ...
            if (pinfo->m_bInMenu == false)
            {
                ...
                if (pinfo->m_bDrawFrame)
                {
                    ...
                    pinfo->m_drl.Add(pcamera->m_sFilmViewX,
  ...
  private:
    ...
    // Setup local dude
    ////////////////////////////////////////////////////////////////////////////////
    void SetupLocalDude(CPlayInfo *pinfo, // I/O: Play info
    ...
    // Setup general dude
    ////////////////////////////////////////////////////////////////////////////////
    void SetupGeneralDude(CDude *pdude,                 // In:  Dude to setup
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    short SetupDudes(CPlayInfo *pinfo,             // I/O: Play info
                     LevelPersist *palevelpersist) // In:  Players' level persistent data.
    {
        short sResult = 0;
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void ScaleFilm(CPlayInfo *pinfo,    // I/O: Play info
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void MakeDemoMovie(RFile *pfileDemoModeDebugMovie) // In:  File for loading/saving demo mode debug movie
    {
            ...
            if (pfileDemoModeDebugMovie->IsOpen())
            {
                ...
                else
                {
                    ...
                    if (im.Load(pfileDemoModeDebugMovie) == 0)
                    {
                        ...
                        U8 *pDstLine = g_pimScreenBuf->m_pData + ((long)FILM_Y * g_pimScreenBuf->m_lPitch) +
                                       (long)FILM_X;
...
class CPlayCutscene : public CPlay
{
  ...
  public:
    ...
    void StartCutscene(CPlayInfo *pinfo) // I/O: Play info
    {
        ...
        RString strSection;
        RString strEntry;
        Play_GetRealmSectionAndEntry(pinfo->IsMP(),
                                     pinfo->CoopLevels(),
                                     pinfo->Gauntlet(),
                                     pinfo->AddOn(),
                                     pinfo->RealmNum(),
                                     pinfo->Realm()->m_flags.sDifficulty,
                                     &strSection,
                                     &strEntry);
    ...
    void DoCutscene(CPlayInfo *pinfo) // I/O: Play info
    {
        ...
        if (!m_bSimple && !pinfo->IsMP())
        {
            ...
            while (rspGetQuitStatus() == 0)
            {
                CutSceneUpdate();
                UpdateSystem();
                if (((rspGetNextInputEvent(&ie) == 1) && (ie.type == RInputEvent::Key)) || IsXInputButtonPressed())
                    break;
            }
        }
    }
  ...
  RFile *pfileDemoModeDebugMovie) // In:  File for loading/saving demo mode debug movie
{
    ...
    {
        if (Play_GetRealmInfo(info.IsMP(),
                              info.CoopLevels(),
                              info.Gauntlet(),
                              info.AddOn(),
                              info.m_sRealmNum,
                              info.Realm()->m_flags.sDifficulty,
                              info.m_szRealm,
                              sizeof(info.m_szRealm)) == 0)
        {
            ...
            if (!sResult && bGameReady)
            {
                ...
                if (sResult == 0)
                {
...
#ifdef MOBILE
                    bool doAutoSaveGame = false; // This is set to true when you complete a level, so it's auto saved
                                                 // when the next realm starts
#endif
                    /*** 12/5/97 AJC ***/
                    ...
                    do
                    {
                        ...
                        if (!sResult)
                        {
                            ...
                            if (!sResult && bRealmReady)
                            {
                                ...
                                if (pclient)
                                {
                                    ...
                                    info.Realm()->m_lScoreInitialTime = info.Realm()->m_lScoreTimeDisplay =
                                      (long)sTimeLimit * (long)60000;
                                ...
                                if (sResult == 0)
                                {
                                    ...
                                    StatsAreAllowed =
                                      !info.IsMP(); // !!! FIXME: we currently only track for single-player (because we
                                                    // don't check that kills belong to the local player, etc).
                        ...
                        const long timePlayedMS = ((startRealmMS > 0) && (endRealmMS > 0) &&
                                                   (endRealmMS > startRealmMS))
                                                    ? endRealmMS - startRealmMS
                                                    : -1;
                        ...
                        if (!g_bLastLevelDemo) // don't charge the last level demo to playthroughMS.
                            playthroughMS = ((playthroughMS < 0) || (timePlayedMS < 0) || (newPlaythroughMS < 0))
                                              ? -1
                                              : newPlaythroughMS;
                        ...
                        if (!sResult)
                        {
                            ...
                            else if (info.IsNextRealm())
                            {
                                ...
                                info.m_sRealmNum++;
                                switch (Play_GetRealmInfo(info.IsMP(),
                                                          info.CoopLevels(),
                                                          info.Gauntlet(),
                                                          info.AddOn(),
                                                          info.m_sRealmNum,
                                                          ...
                                                          sizeof(info.m_szRealm)))
                                {
                                    ...
                                    case 1: // No such realm number
                                        if (info.IsMP())
                                        {
                                            ...
                                            if (Play_GetRealmInfo(info.IsMP(),
                                                                  ...
                                                                  sizeof(info.m_szRealm)) != 0)
                                            {
                                                // 09/12/97 MJR - We don't want to exit the loop if this happens.
                                                // Instead, we set the bad realm flag and let the core loop handle the
                                                // abort process.
                                        ...
                                        else
                                        {
                                            ...
                                            if (!info.Gauntlet() && !info.JustOneRealm() &&
                                                info.RealmNum() == sNumLevels)
                                    ...
                                    default: // Error
                                        // 09/12/97 MJR - In MP, we don't want to exit the loop if this happens.
                                        // Instead, we set the bad realm flag and let the core loop handle the abort
                                        // process.
                                        if (info.IsMP())
                                            info.m_bBadRealmMP = true;
                                        else
  ...
  short sMaxTitleLen /*= NULL*/) // In:  Max length of returned title, including terminating null
{
    ...
    if (sResult == 0)
    {
        ...
        RString strSection;
        RString strEntry;
        Play_GetRealmSectionAndEntry(bNetwork,
                                     bCoop,
                                     bGauntlet,
                                     bAddOn,
                                     sRealmNum,
