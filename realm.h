...
class CRealm
{
  ...
  public:
    ...
    void RegisterDeath(bool bCivilian = false, bool bPlayerKill = true)
    {
        ...
        {
            // need to unlock achievement in here, too, since this fires when starting a level without you killing
            // anything.
    ...
    */
    // Add thing to realm
    void AddThing(CThing *pThing, CThing::ClassIDType id)
    {
    ...
    */
    // Remove thing from realm
    void RemoveThing(CThing *pThing)
    {
        // If in the update loop...
        if (m_bUpdating == true)
        {
    ...
    static bool DoesFileExist(  // Returns true if file exists, false otherwise
    ...
    static short Open(         // Returns 0 if successfull, non-zero otherwise
    ...
    CNavigationNet *GetCurrentNavNet(void) { return m_pCurrentNavNet; }
