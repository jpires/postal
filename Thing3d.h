...
class CThing3d : public CThing
{
  ...
  public:
    ...
    virtual // If you override this, do NOT call this base class.
      CSprite *
      GetSprite(void) // Returns the sprite for this thing or NULL.
    {
        return &m_sprite;
    }
    ...
    virtual CSmash *GetSmash(void) { return &m_smash; }
  ...
  public:
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      bool
      MakeValidPosition(           // Returns true, if new position was validitable.
    ...
    void GetLayer(short sX,        // In:  X coord.
                  short sZ,        // In:  Z coord.
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      CThing3d *
      DetachChild(           // Returns ptr to the child or NULL, if none.
    ...
    virtual // Override to implement additional functionality
            // Call base class to get default functionality
      short
      PrepareShadow(void); // Returns SUCCESS if set successfully
