...
class CNetBrowse
{
    ...
    class CHost
    {
      ...
      public:
        ...
        bool IsSameHost(const CHost *rhs) const
        {
            ...
            if ((strcmp(m_acName, rhs->m_acName) == 0) && (m_address == rhs->m_address) && (m_lMagic == rhs->m_lMagic))
                return true;
            return false;
        }
    };
  ...
  public:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void Update(Hosts *phostsAll,      // I/O:  List of all hosts
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static short LookupHost(       // Returns 0 if successfull, non-zero otherwise
