...
CRealm::CRealm()
{
    ...
    */
    ...
    ms_print.SetColor(STATUS_FONT_FORE_INDEX, STATUS_FONT_BACK_INDEX, STATUS_FONT_SHADOW_INDEX);
                                    ...
                                    // indicates a clear path.
{
    ...
    // Scan while in realm.
    while (fPosX > sMinX && fPosZ > sMinZ && fPosX < sMaxX && fPosZ < sMaxZ && fTotalDistXZ < sDistanceXZ)
    {
