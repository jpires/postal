...
//////////////////////////////////////////////////////////////////////////////
short CGameSettings::LoadPrefs(RPrefs *pPrefs)
{
    short sResult = 0;
    ...
    if (m_sNetBandwidth < 0)
        m_sNetBandwidth = 0;
    if (m_sNetBandwidth >= Net::NumBandwidths)
        m_sNetBandwidth = Net::NumBandwidths - 1;
    pPrefs->GetVal("Multiplayer", "HostMinBandwidth", m_sHostMinBandwidth, &m_sHostMinBandwidth);
    if (m_sHostMinBandwidth < 0)
        m_sHostMinBandwidth = 0;
    if (m_sHostMinBandwidth >= Net::NumBandwidths)
        m_sHostMinBandwidth = Net::NumBandwidths - 1;
    ...
    pPrefs->GetVal("Multiplayer",
                   "HostResetScoresEachLevel",
                   m_sHostResetScoresEachLevel,
                   &m_sHostResetScoresEachLevel);
    ...
    pPrefs->GetVal("Video",
                   "UseCurrentDeviceDimensions",
                   m_sUseCurrentDeviceDimensions,
                   &m_sUseCurrentDeviceDimensions);
    ...
    for (i = 0; i < SampleMaster::MAX_NUM_SOUND_CATEGORIES; i++)
    {
        pPrefs->GetVal("Volumes",
                       SampleMaster::ms_apszSoundCategories[i],
                       SampleMaster::UserDefaultVolume,
                       &m_asCategoryVolumes[i]);
    }
...
//////////////////////////////////////////////////////////////////////////////
short CGameSettings::SavePrefs(RPrefs *pPrefs)
{
...
//////////////////////////////////////////////////////////////////////////////
short CGameSettings::LoadGame(RFile *pFile)
{
...
//////////////////////////////////////////////////////////////////////////////
short CGameSettings::SaveGame(RFile *pFile)
{
...
//////////////////////////////////////////////////////////////////////////////
short CGameSettings::PreDemo(RFile *pFile)
{
    pFile->Write(&m_sDifficulty);
    pFile->Write(&m_sViolence);
    m_sDifficulty = 10;
...
//////////////////////////////////////////////////////////////////////////////
short CGameSettings::PostDemo(RFile *pFile)
{
    pFile->Read(&m_sDifficulty);
    pFile->Read(&m_sViolence);
    return 0;
