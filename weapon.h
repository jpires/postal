...
class CWeapon : public CThing
{
  ...
  public:
    ...
    virtual short Setup(short sX,  // In: Starting X position
    ...
    virtual short SetRangeToTarget(short sRequestedRange) { return sRequestedRange; }
    ...
    virtual // A descended class must define this virtual
      ...
      CSprite *
      GetSprite(void) = 0; // Returns this weapon's sprite.
    ...
    virtual void SetCollideBits( // Returns nothing
    ...
    virtual void SetDetectionBits( // Returns nothing
      U32 u32BitsInclude,          // Bits included in a collision
      U32 u32BitsDontcare,         // Bits that are ignored for collision
      U32 u32BitsExclude)          // Bits that invalidate collision
    {
