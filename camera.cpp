...
// Set camera's scene
////////////////////////////////////////////////////////////////////////////////
void CCamera::SetScene(CScene *pScene) // In:  Scene to take picture of
{
...
// Set camera's hood
////////////////////////////////////////////////////////////////////////////////
void CCamera::SetHood(CHood *pHood) // In:  Hood to use for camera control
{
    // Save specified values
    m_pHood = pHood;
}
...
////////////////////////////////////////////////////////////////////////////////
void CCamera::SetView(short sSceneViewX, // In:  View's upper left x (in scene coords)
...
////////////////////////////////////////////////////////////////////////////////
void CCamera::SetViewPos(short sSceneViewX, // In:  View's upper left x (in scene coords)
                         short sSceneViewY) // In:  View's upper left y (in scene coords)
{
    // Save specified values
    m_sSceneViewX = sSceneViewX;
...
////////////////////////////////////////////////////////////////////////////////
void CCamera::SetViewSize(short sViewW, // In:  View's width
                          short sViewH) // In:  View's height
{
    // Save specified values
    m_sViewW = sViewW;
...
////////////////////////////////////////////////////////////////////////////////
void CCamera::SetFilm(RImage *pimFilm,  // In:  Film (where the picture ends up)
...
////////////////////////////////////////////////////////////////////////////////
void CCamera::Snap(short sViewW,      // In:  View's width
                   short sViewH,      // In:  View's height
