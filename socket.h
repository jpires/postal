...
class RSocket
{
  ...
  public:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static short Startup(           // Returns 0 if successfull, non-zero otherwise
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static short GetMaxDatagramSize( // Returns 0 if successfull, non-zero otherwise
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static void CreateBroadcastAddress(unsigned short usPort,       // In:  Port to broadcast to
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static void SetAddressPort(USHORT usPort,      // In:  New port number
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static const char *GetProtoName( // Returns pointer to protocol's name
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static const char *GetProtoName(void) // Returns pointer to protocol's name
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static RSocket::ProtoType GetProtoType(void) { return ms_prototype; }

  protected:
    ////////////////////////////////////////////////////////////////////////////////
    // Create specified protocol object
    ////////////////////////////////////////////////////////////////////////////////
    static RProtocol *ConstructProtocol( // Returns pointer to prototype if successfull, 0 otherwise
