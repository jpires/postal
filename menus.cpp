...
static char *ms_apszDifficultyDescriptions[] = {
    "Easy", "Easy", "Easy", "Medium", "Medium", "Medium", "Hard", "Hard", "Hard", "Hard", "Masochist",
};
...
// Menu items.
#if defined(SPAWN)
    {
      ...
      {
        g_pszStartMultiplayerMenu_Join,
        TRUE,
        &menuJoinMulti,
        NULL,
      },
      {
        g_pszMainMenu_Options,
        TRUE,
        &menuOptions,
        NULL,
      },
...
extern Menu menuVerifyExit = {
    ...
    // Menu items.
    {
      // pszText,				sEnabled,	pmenu,		pgui
      {
        g_pszVerifyExitMenu_Yes,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszVerifyExitMenu_No,
        TRUE,
        &menuMain,
        nullptr,
      },
...
extern Menu g_menuVerifyQuitGame = {
    ...
    // Menu items.
    {
      // pszText,						sEnabled,	pmenu,		pgui
      {
        g_pszVerifyQuitMenu_Yes,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszVerifyQuitMenu_No,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuEditor = {
    ...
    // Menu items.
    {
      // pszText,							sEnabled,	pmenu,					pgui
      {
        g_pszEditorMenu_Continue,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszEditorMenu_Options,
        TRUE,
        &menuOptions,
        nullptr,
      },
      {
        g_pszEditorMenu_Quit,
        TRUE,
        nullptr,
        nullptr,
      },
...
#endif
      {
        g_pszOptionsMenu_Audio,
        TRUE,
        &menuAudioOptions,
        nullptr,
      },
      {
        g_pszOptionsMenu_Controls,
        TRUE,
        &menuControls,
        nullptr,
      },
...
#endif
      {
        g_pszOptionsMenu_Performance,
        TRUE,
        &menuFeatures,
        nullptr,
      },
      {
        g_pszOptionsMenu_Difficulty,
        TRUE,
        &menuPlayOptions,
        nullptr,
      },
      {
        g_pszOptionsMenu_Crosshair,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuPlayOptions = {
    ...
    // Menu items.
    {
      // pszText,										sEnabled,	pmenu,					pgui
      {
        g_pszDifficultyMenu_SetDifficulty,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuOrgan = {
    ...
    // Menu items.
    {
      ...
      {
        g_pszOrganMenu_SpecialKeysHeading,
        FALSE,
        nullptr,
        nullptr,
      },
      {
        g_pszOrganMenu_NumericKeysFunction,
        FALSE,
        nullptr,
        nullptr,
      },
      {
        g_pszOrganMenu_AlphaKeysFunction,
        FALSE,
        nullptr,
        nullptr,
      },
      {
        g_pszOrganMenu_TabKeyFunction,
        FALSE,
        nullptr,
        nullptr,
      },
...
extern Menu menuAudioOptions = {
    ...
    // Menu items.
    {
      // pszText,				sEnabled,	pmenu,					pgui
      {
        g_pszAudioMenu_Mixer,
        TRUE,
        &menuVolumes,
        nullptr,
      },
      {
        g_pszAudioMenu_SoundTest,
        TRUE,
        &menuOrgan,
        nullptr,
      },
...
extern Menu menuControls = {
    ...
    // Menu items.
    {
      // pszText,												sEnabled,	pmenu,					pgui
      {
        g_pszControlsMenu_KeyboardSetup,
        TRUE,
        &menuKeyboard,
        nullptr,
      },
      {
        g_pszControlsMenu_MouseSetup,
        TRUE,
        &menuMouse,
        nullptr,
      },
      ...
      {
        g_pszControlsMenu_JoystickSetup,
        TRUE,
        &menuJoystick,
        nullptr,
      },
      ...
      {
        g_pszControlsMenu_TurningSpeeds,
        TRUE,
        &menuRotation,
        nullptr,
      },
...
#endif // defined(ALLOW_JOYSTICK)
      {
        g_pszControlsMenu_UseMouse,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszControlsMenu_HorizMouseSensitivity,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszControlsMenu_VertMouseSensitivity,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuFeatures = {
    ...
    // Menu items.
    {
      // pszText,										sEnabled,	pmenu,					pgui
      {
        g_pszPerformanceMenu_Transparency,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszPerformanceMenu_3dLighting,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszPerformanceMenu_Particles,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszPerformanceMenu_DynamicVolume,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszPerformanceMenu_AmbientSounds,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuRotation = {
    ...
    // Menu items.
    {
      // pszText,											sEnabled,	pmenu,					pgui
      {
        g_pszRotationSetupMenu_RunningSlow,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszRotationSetupMenu_RunningFast,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszRotationSetupMenu_StandingSlow,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszRotationSetupMenu_StandingFast,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszRotationSetupMenu_TapDegrees,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszRotationSetupMenu_RestoreDefaults,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuStart = {
    ...
    // Menu items.
    {
      // pszText,											sEnabled,	pmenu,				pgui
      {
        g_pszStartGameMenu_SinglePlayer,
        TRUE,
        &menuStartSingle,
        nullptr,
      },
#ifndef MULTIPLAYER_REMOVED
      {
        g_pszStartGameMenu_Multiplayer,
        TRUE,
        &menuStartMulti,
        NULL,
      },
...
extern Menu menuStartSingle = {
    ...
    // Menu items.
    {
      // pszText,											sEnabled,	pmenu,				pgui
      {
        g_pszStartSinglePlayerMenu_New,
        TRUE,
        nullptr,
        nullptr,
      },
      ...
      {
        g_pszStartSinglePlayerMenu_AddOn,
        TRUE,
        nullptr,
        nullptr,
      },
...
#endif
      {
        g_pszStartSinglePlayerMenu_LoadGame,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszStartSinglePlayerMenu_Challenge,
        TRUE,
        /*&menuChallenge,*/ nullptr,
        nullptr,
      },
      {
        "",
...
extern Menu menuChallenge = {
    ...
    // Menu items.
    {
      // pszText,					sEnabled,		pmenu,		pgui
      {
        g_pszStartChallengeMenu_Gauntlet,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuStartMulti = {
    ...
    // Menu items.
    {
      ...
      {
        g_pszStartMultiplayerMenu_Host,
        TRUE,
        &menuHostMulti,
        nullptr,
      },
      {
        g_pszStartMultiplayerMenu_Options,
        TRUE,
        &menuMultiOptions,
        nullptr,
      },
...
extern Menu menuJoinMulti = {
    ...
    // Menu items.
    {
      // pszText,								sEnabled,	pmenu,					pgui
      {
        g_pszJoinGameMenu_Browse,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszJoinGameMenu_ConnectTo,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuStartDemo = {
    ...
    // Menu items.
    {
      ...
      {
        g_pszStartDemoMenu_Play,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszStartDemoMenu_Record,
        TRUE,
        nullptr,
        nullptr,
      },
...
extern Menu menuMultiOptions = {
    ...
    // Menu items.
    {
      // pszText,				sEnabled,	pmenu,			pgui
      {
        g_pszMultiplayerSetupMenu_Name,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszMultiplayerSetupMenu_Color,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszMultiplayerSetupMenu_Protocol,
        TRUE,
        nullptr,
        nullptr,
      },
      {
        g_pszMultiplayerSetupMenu_Connection,
        TRUE,
        nullptr,
        nullptr,
      },
  ...
  short sInit)            // TRUE, if initializing; FALSE, if killing.
{
    ...
    if (sInit != FALSE)
    {
        ...
        short i;
        for (i = 0; i < SampleMaster::MAX_NUM_SOUND_CATEGORIES && sRes == 0 && i < (NUM_ELEMENTS(pmenuCur->ami) - 2);
             i++)
        {
        ...
        case SampleMaster::MAX_NUM_SOUND_CATEGORIES: // Restore defaults.
        {
            ...
            for (i = 0; i < SampleMaster::MAX_NUM_SOUND_CATEGORIES && i < NUM_ELEMENTS(pmenuCurrent->ami); i++)
            {
                if (pmenuCurrent->ami[i].pgui)
                {
                    ...
                    ((RScrollBar *)(pmenuCurrent->ami[i].pgui))
                      ->SetPos(SampleMaster::UserDefaultVolume * lRange / SampleMaster::UserMaxVolume);
    ...
    if (sInit != FALSE)
    {
        ...
        if (rspGetResource(&g_resmgrShell, PLAYER_COLOR_GUI_FILE, &ms_ptxtColor) == 0)
        {
            ...
            if (g_GameSettings.m_sPlayerColorIndex >= CGameSettings::ms_sNumPlayerColorDescriptions ||
                g_GameSettings.m_sPlayerColorIndex >= CDude::MaxTextures || g_GameSettings.m_sPlayerColorIndex < 0)
            {
            ...
            // resource!
            ms_ptxtColor->SetText("%s",
                                  CGameSettings::ms_apszPlayerColorDescriptions[g_GameSettings.m_sPlayerColorIndex]);
