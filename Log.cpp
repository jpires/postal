...
short OpenLogFile()
{
    ...
    if (g_GameSettings.m_bLogNetTime)
    {
        if (!g_GameSettings.m_rfNetSyncLog.IsOpen())
        {
            ...
            if (g_GameSettings.m_rfNetSyncLog.Open(g_GameSettings.m_szNetSyncLogFile, "wt+", RFile::BigEndian) != 0)
#else
            if (g_GameSettings.m_rfNetSyncLog.Open(g_GameSettings.m_szNetSyncLogFile, "wt+", RFile::LittleEndian) != 0)
#endif
            {
                sResult = 1;
...
//		global variables used:		g_GameSettings
////////////////////////////////////////////////////////////////////////////////
extern short WriteTimeStamp(char *pszCaller,         // Name of calling routine
