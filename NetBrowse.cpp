  ...
  RSocket::BLOCK_CALLBACK callback) // In:  Blocking callback
{
    ...
    sResult = m_socketBrowse.Open(m_usBasePort + Net::BroadcastPortOffset,
                                  RSocket::typDatagram,
...
////////////////////////////////////////////////////////////////////////////////
void CNetBrowse::Update(Hosts *phostsAll,     // I/O:  List of all hosts
                        ...
                        Hosts *phostsRemoved) // I/O:  List of hosts that were removed
{
    ...
    if (serr == 0)
    {
        ...
        if ((lReceived == sizeof(buf)) && (buf[0] == Net::BroadcastMagic0) && (buf[1] == Net::BroadcastMagic1) &&
            (buf[2] == Net::BroadcastMagic2) && (buf[3] == Net::BroadcastMagic3))
        {
            ...
            host.m_lMagic = ((long)buf[4] & 0x000000ff) + (((long)buf[5] << 8) & 0x0000ff00) +
                            (((long)buf[6] << 16) & 0x00ff0000) + (((long)buf[7] << 24) & 0xff000000);
