...
#define IMAGE_CURRENT_VERSION                                                                                          \
    5 // Current file version.  Change
...
#define GETTOFUNC(lIndex) RImageSpecialFunc::ms_apfnConvTo[lIndex]

#define GETFROMFUNC(lIndex) RImageSpecialFunc::ms_apfnConvFrom[lIndex]

#define GETLOADFUNC(lIndex) RImageSpecialFunc::ms_apfnLoad[lIndex]

#define GETSAVEFUNC(lIndex) RImageSpecialFunc::ms_apfnSave[lIndex]

#define GETALLOCFUNC(lIndex) RImageSpecialFunc::ms_apfnAlloc[lIndex]

#define GETDELETEFUNC(lIndex) RImageSpecialFunc::ms_apfnDelete[lIndex]
...
#define IMAGELINKINSTANTIATE()                                                                                         \
    CONVTOFUNC RImageSpecialFunc::ms_apfnConvTo[END_OF_TYPES] = {                                                      \
        NULL,                                                                                                          \
    };                                                                                                                 \
    CONVFROMFUNC RImageSpecialFunc::ms_apfnConvFrom[END_OF_TYPES] = {                                                  \
        NULL,                                                                                                          \
    };                                                                                                                 \
    LOADFUNC RImageSpecialFunc::ms_apfnLoad[END_OF_TYPES] = {                                                          \
        NULL,                                                                                                          \
    };                                                                                                                 \
    SAVEFUNC RImageSpecialFunc::ms_apfnSave[END_OF_TYPES] = {                                                          \
        NULL,                                                                                                          \
    };                                                                                                                 \
    ALLOCFUNC RImageSpecialFunc::ms_apfnAlloc[END_OF_TYPES] = {                                                        \
        NULL,                                                                                                          \
    };                                                                                                                 \
    DELETEFUNC RImageSpecialFunc::ms_apfnDelete[END_OF_TYPES] = {                                                      \
        NULL,                                                                                                          \
    }
...
//
///////////////////////////////////////////////////////////////////////////////
#define CONVTOTOUCH(TYPE)                                                                                              \
    extern void ReferenceConvTo##TYPE(void)                                                                            \
    {                                                                                                                  \
        extern short ConvertTo##TYPE(RImage *);                                                                        \
        ConvertTo##TYPE(NULL);                                                                                         \
    }

#define CONVFROMTOUCH(TYPE)                                                                                            \
    extern void ReferenceConvFrom##TYPE(void)                                                                          \
    {                                                                                                                  \
        extern short ConvertFrom##TYPE(RImage *);                                                                      \
        ConvertFrom##TYPE(NULL);                                                                                       \
    }

#define SAVETOUCH(TYPE)                                                                                                \
    extern void ReferenceSave##TYPE(void)                                                                              \
    {                                                                                                                  \
        extern short Save##TYPE(RImage *, RFile *);                                                                    \
        Save##TYPE(NULL, NULL);                                                                                        \
    }

#define LOADTOUCH(TYPE)                                                                                                \
    extern void ReferenceLoad##TYPE(void)                                                                              \
    {                                                                                                                  \
        extern short Load##TYPE(RImage *, RFile *);                                                                    \
        Load##TYPE(NULL, NULL);                                                                                        \
    }

#define ALLOCTOUCH(TYPE)                                                                                               \
    extern void ReferenceAlloc##TYPE(void)                                                                             \
    {                                                                                                                  \
        extern short Alloc##TYPE(RImage *);                                                                            \
        Alloc##TYPE(NULL);                                                                                             \
    }

#define DELETETOUCH(TYPE)                                                                                              \
    extern void ReferenceDelete##TYPE(void)                                                                            \
    {                                                                                                                  \
