...
char *RImage::ms_astrTypeNames[END_OF_TYPES] = {
    "Same Type",    "BMP8",         "SYSTEM8",      "SCREEN8_555",   "SCREEN8_565", "SCREEN8_888", "BMP24",
    "SCREEN16_555", "SCREEN16_565", "SCREEN24_RGB", "SCREEN32_ARGB", "FSPR1",       "FSPR8",       "FSPR16",
    "FSPR32",       "ROTBUF",       "SPECIAL",      "FLX8_888",      "IMAGE_STUB",  "BMP8RLE",
...
RImage::Type RImage::Convert(Type type)
{
    ...
    else
    {
        ...
        if (m_type >= BMP8 && m_type <= SCREEN32_ARGB)
        {
                ...
                if (pcf->Read(&(dfh.ulSize), 1) == 1)
                {
                    if (pcf->Read(&(dfh.usReserved1), 1) == 1)
                    {
                        if (pcf->Read(&(dfh.usReserved2), 1) == 1)
                        {
                                    ...
                                    if (pcf->Read(&(dh.lWidth), 1) == 1)
                                    {
                                        if (pcf->Read(&(dh.lHeight), 1) == 1)
                                        {
                                            if (pcf->Read(&(dh.usPlanes), 1) == 1)
                                            {
                                                    ...
                                                    if (pcf->Read(&(dh.ulCompression), 1) == 1)
                                                    {
                                                        if (pcf->Read(&(dh.ulSizeImage), 1) == 1)
                                                        {
                                                            if (pcf->Read(&(dh.lXPelsPerMeter), 1) == 1)
                                                            {
                                                                if (pcf->Read(&(dh.lYPelsPerMeter), 1) == 1)
                                                                {
                                                                    if (pcf->Read(&(dh.ulClrUsed), 1) == 1)
                                                                    {
                                                                        if (pcf->Read(&(dh.ulClrImportant), 1) == 1)
                                                                        {
                                                                            ...
                                                                            m_sHeight = m_sWinHeight = (short)
                                                                                                         dh.lHeight;
                                                                            m_sWinX = m_sWinY = 0;

                                                                            // Pre calc width in bits.
                                                                            long lBitsWidth = dh.lWidth *
                                                                                              (long)dh.usBitCount;
                                                                            m_lPitch = WIDTH128(
                                                                              ((lBitsWidth + 7) & ~7) / 8);
                                                                            lDibPitch = WIDTHUCHAR(
                                                                              ((lBitsWidth + 7) & ~7) / 8);
                                                                            ...
                                                                            if (CreateData(m_ulSize) == 0)
                                                                            {
                                                                                if (dh.usBitCount <= 8)
                                                                                {
                                                                                    // Read palette in one chunk since
                                                                                    // only on this platform.
                                                                                    short sNumColors = 1
                                                                                                       << dh.usBitCount;
                                                                                    CreatePalette(sNumColors * 4);
                                                                                    m_pPalette->m_sNumEntries =
                                                                                      sNumColors;
                                                                                    m_pPalette->m_sPalEntrySize = 4;
                                                                                    if (pcf->Read(m_pPalette->m_pData,
                                                                                                  4 * sNumColors) ==
                                                                                        4 * sNumColors)
                                                                                    {
                                                                                    }
                                                                                ...
                                                                                if (sRes == 0)
                                                                                {
                                                                                                  ...
                                                                                                  SEEK_SET) == 0)
                                                                                    {
                                                                                        ...
                                                                                        if (dh.ulCompression == 0)
                                                                                        {
                                                                                            // If we read in the upside
                                                                                            // down way . . . "Upside
                                                                                            // down" way. Read the dib a
                                                                                            // line at a time and flip
                                                                                            // it upside down (which is
                                                                            ...
                                                                            {
                                                                                TRACE("RImage::LoadDib(): Unable to "
                                                                                      "allocate DIB.\n");
                                                                                sRes = -18;
                                                                            }
                                                                        }
                                                                        ...
                                                                        {
                                                                            TRACE("RImage::LoadDib(): Unable to read "
                                                                                  "colors important field of bitmap "
                                                                                  "info header.\n");
                                                                            sRes = -17;
                                                                        }
                                                                    }
                                                                    ...
                                                                    {
                                                                        TRACE(
                                                                          "RImage::LoadDib(): Unable to read colors "
                                                                          "used field of bitmap info header.\n");
                                                                        sRes = -16;
                                                                    }
                                                                }
                                                                else
                                                                {
                                                                    TRACE(
                                                                      "RImage::LoadDib(): Unable to read vert pixels "
                                                                      "per meter field of bitmap info header.\n");
                                                                    sRes = -15;
                                                                }
                                                            }
                                                            else
                                                            {
                                                                TRACE("RImage::LoadDib(): Unable to read horz pixels "
                                                                      "per meter field of bitmap info header.\n");
                                                                sRes = -14;
                                                            }
                                                        }
                                                        ...
                                                        {
                                                            TRACE("RImage::LoadDib(): Unable to read size of image "
                                                                  "field of bitmap info header.\n");
                                                            sRes = -13;
                                                        }
                                                    }
                                                    else
                                                    {
                                                        TRACE("RImage::LoadDib(): Unable to read compression field of "
                                                              "bitmap info header.\n");
                                                        sRes = -12;
                                                    }
                                                }
                                                ...
                                                {
                                                    TRACE("RImage::LoadDib(): Unable to read bit count field of bitmap "
                                                          "info header.\n");
                                                    sRes = -11;
                                                }
                                            }
                                            ...
                                            {
                                                TRACE("RImage::LoadDib(): Unable to read planes field of bitmap info "
                                                      "header.\n");
                                                sRes = -10;
                                            }
                                        }
                                        ...
                                        {
                                            TRACE("RImage::LoadDib(): Unable to read height field of bitmap info "
                                                  "header.\n");
                                            sRes = -9;
                                        }
                                    }
                            ...
                            {
                                TRACE(
                                  "RImage::LoadDib(): Unable to read offset to bits field of bitmap file header.\n");
                                sRes = -6;
                            }
                        }
                        else
                                ...
                                if (pcf->Write(&lWidth) == 1L)
                                {
                                    ...
                                    if (pcf->Write(&lHeight) == 1L)
                                    {
                                        if (pcf->Write(&dh.usPlanes) == 1L)
                                        {
                                            if (pcf->Write(&m_sDepth) == 1L)
                                            {
                                                if (pcf->Write(&dh.ulCompression) == 1L)
                                                {
                                                    if (pcf->Write(&dh.ulSizeImage) == 1L)
                                                    {
                                                        if (pcf->Write(&dh.lXPelsPerMeter) == 1L)
                                                        {
                                                            if (pcf->Write(&dh.lYPelsPerMeter) == 1L)
                                                            {
                                                                if (pcf->Write(&dh.ulClrUsed) == 1L)
                                                                {
                                                                    if (pcf->Write(&dh.ulClrImportant) == 1L)
                                                                    {
                                                                        if (m_pPalette != nullptr)
                                                                        {
                                                                            if (pcf->Write(m_pPalette->m_pData,
                                                                                           m_pPalette->m_ulSize) ==
                                                                                (long)m_pPalette->m_ulSize)
                                                                            {
                                                                            }
                                                                            else
                                                                            {
                                                                                TRACE("RImage::SaveDib: Unable to "
                                                                                      "write palette.\n");
                                                                                sRes = -20;
                                                                            }
                                                                        }
                                                                        ...
                                                                        if (sRes == 0)
                                                                        {
                                                                            ...
                                                                            {
                                                                                // Upside down way.
                                                                                // Write the dib a line at a time and
                                                                                // flip it upside down (which is really
                                                                                // right side up)
                                                                                lHeight = (long)m_sHeight;
                                                                                for (long l = lHeight - 1L; l >= 0L;
                                                                                     l--)
                                                                                {
                                                                                    if (pcf->Write(
                                                                                          m_pData + (l * m_lPitch),
                                                                    ...
                                                                    {
                                                                        TRACE(
                                                                          "RImage::SaveDib: Unable to write colors "
                                                                          "important field of bitmap info header.\n");
                                                                        sRes = -17;
                                                                    }
                                                                }
                                                                else
                                                                {
                                                                    TRACE("RImage::SaveDib: Unable to write colors "
                                                                          "used field of bitmap info header.\n");
                                                                    sRes = -16;
                                                                }
                                                            }
                                                            ...
                                                            {
                                                                TRACE("RImage::SaveDib: Unable to write vert pixels "
                                                                      "per meter field of bitmap info header.\n");
                                                                sRes = -15;
                                                            }
                                                        }
                                                        ...
                                                        {
                                                            TRACE("RImage::SaveDib: Unable to write horz pixels per "
                                                                  "meter field of bitmap info header.\n");
                                                            sRes = -14;
                                                        }
                                                    }
                                                    else
                                                    {
                                                        TRACE("RImage::SaveDib: Unable to write size of image field of "
                                                              "bitmap info header.\n");
                                                        sRes = -13;
                                                    }
                                                }
                                                ...
                                                {
                                                    TRACE("RImage::SaveDib: Unable to write compression field of "
                                                          "bitmap info header.\n");
                                                    sRes = -12;
                                                }
                                            }
                                            ...
                                            {
                                                TRACE("RImage::SaveDib: Unable to write bit count field of bitmap info "
                                                      "header.\n");
                                                sRes = -11;
                                            }
                                        }
                                        ...
                                        {
                                            TRACE(
                                              "RImage::SaveDib: Unable to write planes field of bitmap info header.\n");
                                            sRes = -10;
                                        }
                                    }
                                    else
