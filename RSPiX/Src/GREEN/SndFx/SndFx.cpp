...
#define FIXED_POINT_DEPTH                                                                                              \
    1000 // Depth of fixed point notation (e.g.,
...
//
/////////////////////////////////////////////////////////////////////////
template<class TYPE>  // Data type, signed.
...
//
/////////////////////////////////////////////////////////////////////////
template<class UTYPE>         // Data type, unsigned.
                    ...
                    switch (ms_lBitsPerSample)
                    {
                        case 8:
                        {
                            UnsignedDecimate(   // Returns nothing.
                              ...
                              ms_pu8Fade +
                                (m_lFadeInBytesDurationAffected / m_lFadeInRate) * 256); // Attenuation Table.
                            break;
                        }
                        case 16:
                        {
                        ...
                        switch (ms_lBitsPerSample)
                        {
                            case 8:
                            {
                                UnsignedDecimate(   // Returns nothing.
                                  ...
                                  lBufSize,         // Number of bytes in buffer.
                                  ms_pu8Fade +
                                    (m_lFadeOutBytesDurationRemaining / m_lFadeOutRate) * 256); // Attenuation Table.
                                break;
                            }
                            case 16:
                            {
