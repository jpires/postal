...
//
short rspBlitToMono(RImage *pimSrc, RImage *pimDst, short sDstX, short sDstY, short sDstW, short sDstH)
{
#ifdef _DEBUG
    ...
    if ((sDstX < 0) || (sDstY < 0) || ((sDstX + sDstW) > pimDst->m_sWidth) || ((sDstY + sDstH) > pimDst->m_sHeight))
    {
...
// mono rect ....
//
short rspRectToMono(ULONG ulColor, RImage *pimDst, short sX, short sY, short sW, short sH)
{
#ifdef _DEBUG
    ...
    if ((sX < 0) || (sY < 0) || ((sX + sW) > pimDst->m_sWidth) || ((sY + sH) > pimDst->m_sHeight))
    {
