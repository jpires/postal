...
//====================================================================
extern void rspAlphaBlit(RAlpha *pX,     // Set for current palette and alpha level
...
// also the most limited.
//====================================================================
extern void rspAlphaBlitT(RAlpha *pX,     // Set for current palette and alpha level
                          RImage *pimSrc, //	BMP8 source
                          RImage *pimDst, //	BMP8 destination
                          short sDstX,
                          short sDstY);
...
//
//====================================================================
extern void rspAlphaBlitT(short sAlphaLevel,    // 255 = opaque
...
//									by it's COLOR - sheet of glass effect.
//====================================================================
extern void rspGeneralAlphaBlit(RMultiAlpha *pX, // For current palette
...
//
//====================================================================
extern void rspGeneralAlphaBlit(short sLevel,    // 0-255, 255 = unchanged
...
//
//====================================================================
extern void rspGeneralAlphaBlitT(short sLevel,    // 0-255, 255 = unchanged
                                 RMultiAlpha *pX, // for current palette
                                 RImage *pimMask, // BMP8 alpha channel mask
                                 RImage *pimSrc,  // BMP8 source
                                 RImage *pimDst,  // BMP8 destination
...
//
//====================================================================
extern void rspFastAlphaBlitT(short sAlphaLevel, // 0-255, 255 = unchanged
...
//									by it's COLOR - sheet of glass effect.
//====================================================================
extern void rspFastMaskAlphaBlit(UCHAR ***pfaX,   // A fast multialpha table
...
//									the alpha mask (which could be useful)
//====================================================================
extern void rspFastMaskAlphaBlitT(UCHAR ***pfaX,   // A fast multialpha table
                                  RImage *pimMask, // BMP8 source alpha channel mask
                                  RImage *pimSrc,  // BMP8 source
                                  RImage *pimDst,  // BMP8 destination
                                  short sDstX,
...
//
inline short rspSimpleClip(short &sSrcX,
                           short &sSrcY,
                           short &sDstX,
                           short &sDstY,
                           short &sDstW,
...
inline UCHAR rspBlendColor(short sLevel, RMultiAlpha *pX, UCHAR ucSrc, UCHAR ucDst)
{
    ...
    if (sLevel > *(pX->m_pLevelOpacity))
    {
        ...
        if (ppucAlpha)
            return ppucAlpha[ucSrc][ucDst]; // alpha'ed
        return ucSrc;                       // opaque
    }
...
//====================================================================
extern void rspMaskBlit(RImage *pimSrc, // BMP8
                        RImage *pimDst,
                        short sDstX,
                        short sDstY);
