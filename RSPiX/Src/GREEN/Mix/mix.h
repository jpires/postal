...
class RMix
{
  public: // Enums and typedefs.
    ...
    // Callback.
    typedef void *(*RMixCall)(Msg msg, void *pData, ULONG *pulBufSize, ULONG ulUser, UCHAR *pucVol1, UCHAR *pucVol2);
  ...
  public: // Methods.
    ...
    short OpenChannel(long lSampleRate, long lBitsPerSample, long lNumChannels);
    ...
    // Returns 0 on success.
    short Start(RMixCall mcUser, ULONG ulUser, UCHAR ucVolume = 255, UCHAR ucVol2 = 255);
    ...
    {
        ms_ulBufSize = 0;
        rspSetSoundOutBufferTime(lBufferTime);
    }
