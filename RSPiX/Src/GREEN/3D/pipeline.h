...
class RPipeLine
{
  public:
    ...
    void TransformShadow(RSop *pPts, RTransform &tObj, short sHeight = 0, short *psOffX = NULL, short *psOffY = NULL);
    ...
    void Render(RImage *pimDst, short sDstX, short sDstY, RMesh *pMesh, UCHAR ucColor); // wire frame!
    ...
    //
    void BoundingSphereToScreen(RP3d &ptCenter, RP3d &ptRadius, RTransform &tObj);
