...
// triangle color!
//
extern void DrawTri_ZColorFog(UCHAR *pDst,
                              long lDstP,
                              RP3d *p1,
                              RP3d *p2,
                              RP3d *p3,
...
//==================================================
// For debugging:
extern void DrawTri_wire(RImage *pimDst, short sX, short sY, RP3d *p1, RP3d *p2, RP3d *p3, UCHAR ucColor);

extern void DrawTri_ZColor(UCHAR *pDst,
                           long lDstP,
                           RP3d *p1,
                           RP3d *p2,
                           RP3d *p3,
...
//
extern void DrawTri(UCHAR *pDstOffset, long lDstP, RP3d *p1, RP3d *p2, RP3d *p3, UCHAR ucFlatColor);
