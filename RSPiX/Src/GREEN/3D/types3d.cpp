...
void RTexture::Remap(short sStartIndex, short sNumIndex, UCHAR *pr, UCHAR *pg, UCHAR *pb, long linc)
{
    ASSERT(m_pColors);
    ...
    {
        m_pIndices[i] = rspMatchColorRGB(long(m_pColors[i].u8Red),
...
////////////////////////////////////////////////////////////////////////////////
void RTexture::Unmap(UCHAR *pr, UCHAR *pg, UCHAR *pb, long lInc)
{
    ASSERT(m_pIndices);
...
////////////////////////////////////////////////////////////////////////////////
void RTexture::Adjust(float fAdjustment, // In:  Adjustment factor (1.0 == same, < 1 == dimmer, > 1 == brighter).
