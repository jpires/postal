...
extern void rspSetDoSystemMode(short sMode); // In:  Mode (use RSP_DOSYSTEM_* macros)
...
extern void rspGetMouse(short *psX,        // X position returned here (unless NULL)
                        short *psY,        // Y position returned here (unless NULL)
                        short *psButtons); // button status returned here (unless NULL)

extern void rspSetMouse(short sX,  // New x position
...
// is currently showing, while a level of 0 or less means the cursor is hidden.
extern void rspSetMouseCursorShowLevel(short sLevel); // In:  New cursor level
...
extern void rspScanKeys(unsigned char *pucKeys); // Out: Array of 128 unsigned chars (one per SK code)
...
// previous.
extern void rspUpdateJoy(short sJoy); // In:  Joystick to query.
...
extern void rspGetJoyPos(short sJoy,        // In:  Joystick to query.
...
// This function returns directions in an analog format (0..0xFFFF).
extern void rspGetJoyPrevPos(short sJoy,        // In:  Joystick to query.
                             long *plX,         // Out: X axis position of joystick, if not NULL.
                             long *plY = NULL,  // Out: Y axis position of joystick, if not NULL.
                             long *plZ = NULL,  // Out: Z axis position of joystick, if not NULL.
                             long *plW = NULL,  // Out: W axis position of joystick, if not NULL.
...
extern void rspGetJoyState(short sJoy,            // In:  Joystick to query.
...
// This function returns directions in a digital format (up, down, centered).
extern void rspGetJoyPrevState(short sJoy,            // In:  Joystick to query.
                               U32 *pu32Buttons,      // Out: Buttons that are down, if not NULL.
                                                      // An RSP_JOY_BUT_## bit field that is set indicates
                                                      // that button is down.
                               U32 *pu32Axes = NULL); // Out: Directions that are specificed, if not NULL.
...
extern void rspSetMacVideoUpdateOptions(short sMethod,         // In:  Method to be used
...
extern void rspCacheDirtyRect(short sX,       // x coord of upper-left corner of area to update
...
extern void rspUpdateDisplay(short sX,       // In:  X coord of upper-left corner of area to update
...
extern void rspSetPaletteEntry(short sEntry,          // In:  Palette entry (0 to 255)
...
extern void rspSetPaletteEntries(short sStartEntry,       // In:  Starting destination entry (0 to 255)
...
extern void rspGetPaletteEntries(short sStartEntry,       // In:  Starting source entry (0 to 255)
                                 short sCount,            // In:  Number of entries to do (1 to 256)
...
inline void rspGetPaletteEntry(short sEntry,            // In:  Palette entry (0 to 255)
...
extern void rspLockPaletteEntries(short sStartEntry, // In:  Starting entry (0 to 255)
                                  short sCount);     // In:  Number of entries to do (1 to 256)
...
extern void rspUnlockPaletteEntries(short sStartEntry, // In:  Starting entry (0 to 255)
                                    short sCount);     // In:  Number of entries to do (1 to 256)
...
extern void rspSetPaletteMaps(short sStartEntry,       // In:  Starting destination entry (0 to 255)
                              short sCount,            // In:  Number of entries to do (1 to 256)
                              unsigned char *pucRed,   // In:  Pointer to starting source red value
                              unsigned char *pucGreen, // In:  Pointer to starting source green value
                              unsigned char *pucBlue,  // In:  Pointer to starting source blue value
...
extern void rspGetPaletteMaps(short sStartEntry,       // In:  Starting source entry (0 to 255)
                              short sCount,            // In:  Number of entries to do (1 to 256)
                              unsigned char *pucRed,   // Out: Pointer to starting destination red value
                              unsigned char *pucGreen, // Out: Pointer to starting destination green value
                              unsigned char *pucBlue,  // Out: Pointer to starting destination blue value
...
extern void rspSetSoundOutBufferTime(long lCurBufferTime); // In:  New buffer time
...
extern void rspSetApplicationName(char *pszName); // In: Application name
...
extern void rspSetBackgroundCallback(void(BackgroundCallback)(void)); // In:  Function to be called

extern void rspSetForegroundCallback(void(ForegroundCallback)(void)); // In:  Function to be called
