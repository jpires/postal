...
class RChanCore
{
  ...
  public:
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    virtual void Reset(void) { m_sLoopFlags = 0; }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    virtual void CreateItems(long lNumItems) // In:  Number of items
      = 0;                                   // Abstract function!
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    virtual void Compress(void) = 0; // Abstract function!
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    virtual void Decompress(void) = 0; // Abstract function!
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    virtual void SetItem(long lNum,          // In:  Item number
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    virtual void SetTotalTime(long lTotalTime) // In:  Total time
      = 0;                                     // Abstract function!
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    virtual void SetResolution(long lResolution) // In:  New resolution
      = 0;                                       // Abstract function!
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void SetLooping(short sLoopFlags) { m_sLoopFlags = sLoopFlags; }
};
...
class RChanCoreNothing : public RChanCore<datat>
{
  ...
  public:
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void CreateItems(long lNumItems) // In:  Number of items
    {
    }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void SetItem(long lNum,          // In:  Item number
                 const datat *pdata) // In:  Pointer to data to be added
    {
    }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void SetTotalTime(long lTotalTime) // In:  Total time
    {
    }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void SetResolution(long lResolution) // In:  New resolution
    {
    }
};
...
class RChanCoreArray : public RChanCore<datat>
{
  ...
  public:
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    long TotalTime(void) { return m_lTotalTime; }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    long Resolution(void) { return m_lInterval; }
                ...
                for (long l = 0; (l < m_lNumItems) && (sResult == 0); l++)
                {
                    ...
                    if (pFile->Read(&lValue) == 1)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                TRACE("RChanCoreArrayOfPtrs::Load(): Internal error: Reference to item that hasn't "
                                      "been loaded yet!\n");
                                sResult = -1;
                            }
                        }
...
class RChannel
{
  ...
  public:
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void SetType(RChannel_Types type) // In:  New type
    {
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void SetName(const char *pszName) // In:  Name
    {
        m_strName = pszName;
    }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void Compress(void) { m_pcore->Compress(); }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void Decompress(void) { m_pcore->Decompress(); }
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    void SetLooping(short sLoopFlags) // In:  New loop flags
    {
