                                    ...
                                    // activated by ESCAPE key.
{
    ...
    // Create erase buffer . . .
    if (m_imEraser.CreateImage(pguiRoot->m_im.m_sWidth,
                              ...
                              // image.
{
    ...
    m_drl.Add(pgui->m_sX, pgui->m_sY, pgui->m_im.m_sWidth, pgui->m_im.m_sHeight);
