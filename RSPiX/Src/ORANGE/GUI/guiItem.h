...
class RGuiItem : public RProps<U32, U32>
{
  ...
  public: // Methods.
    ...
    void SetFont(RFont *pfnt, short sHeight) { m_pprint->SetFont(sHeight, pfnt); }

    // Set the text that represents this item.
    void SetText(char *pszFrmt, // sprintf formatted format string.
    ...
    virtual // If you override this, call this base if possible.
      void
      DrawBackground(        // Returns nothing.
        RImage *pim = NULL); // Dest image, uses m_im if NULL.
    ...
    virtual // If you override this, call this base if possible.
      void
      DrawBackgroundRes(     // Returns nothing.
        RImage *pim = NULL); // Dest image, uses m_im, if NULL.
  ...
  public: // Static
    ...
    virtual // If you override this, call this base if possible.
      short
      ReadMembers(       // Returns 0 on success.
    ...
    virtual // If you override this, call this base if possible.
      short
      WriteMembers(    // Returns 0 on success.
  ...
  public:
    ...
    virtual short GetTopLeftBorderThickness(void); // Returns border thickness
                                                   // including edge effect.

    // Gets the thickness of the bottom/right border (including border edge effect).
    virtual short GetBottomRightBorderThickness(void); // Returns border thickness
                                                       // including edge effect.
    ...
    short IsChild(RGuiItem *pguiChild) // In:  Item to check.
    {
  ...
  protected: // Internal functions.
    ...
    static void HotCall(RHot *phot,       // In:  Ptr to RHot that generated event.
                        RInputEvent *pie) // In:  Most recent user input event.
                                          // Out: pie->sUsed = TRUE, if used.
    {
    ...
    virtual short SaveChildren( // Returns 0 on success.
      RFile *pfile);            // File to save to.

    // Load item's children from the specified file.
    virtual short LoadChildren( // Returns 0 on success.
