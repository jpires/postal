...
class RListBox : public RGuiItem
{
  ...
  public: // Methods.
    ...
    short IsListItem(RGuiItem *pguiListItem) // In:  Item to check.
    {
  ...
  public: // Static.
      ...
      RScrollBar *psb)      // Scroll bar.
    {
        ...
        {
            // Move vertically.
            plb->m_lcContents.Move(plb->m_lcContents.m_sX, -sPos);
        }
        else
        {
            // Move horizontally.
            plb->m_lcContents.Move(-sPos, plb->m_lcContents.m_sY);
        }
    }
