  ...
  RImage *pim /*= NULL*/) // Dest image, uses m_im if NULL.
{
    ...
    if (m_btnUp.Create(sX, sY, sBtnWidth, sBtnHeight, m_im.m_sDepth) == 0)
    {
        ...
        if (m_btnDown.Create(sX + sW - sBtnWidth, sY + sH - sBtnHeight, sBtnWidth, sBtnHeight, m_im.m_sDepth) == 0)
        {
        }
        else
        {
                              ...
                              // Out: pie->sUsed = TRUE, if used.
{
    switch (pie->sEvent)
    {
        ...
        case RSP_MB0_PRESSED:
        {
            ...
            if (pie->sPosX < m_btnThumb.m_sX || pie->sPosX >= m_btnThumb.m_sX + m_btnThumb.m_im.m_sWidth ||
...
//
////////////////////////////////////////////////////////////////////////
void RScrollBar::SetRange(long lMin, long lMax)
{
