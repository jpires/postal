...
class R3DRay : public RRay
{
  public:
    ...
    {
        X = Y = Z = 0;
        fXVect = fYVect = fZVect = (float)0.0;
    };
...
class RRectangle
{
  public:
    ...
    // Constructors
    RRectangle() { lLeft = lRight = lTop = lBottom = 0; };
...
class RCube
{
  public:
    ...
    // Constructors
    RCube() { lLeft = lRight = lTop = lBottom = lFront = lBack = 0; };
