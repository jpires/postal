...
RSprite::RSprite(short sX, short sY, short sZ, short sAngle, long lWidth, long lHeight, ULONG ulFlags, RImage *pImage)
{
                                                                ...
                                                                if (pcf->Write(&m_dXvel) == 1)
                                                                {
                                                                    if (pcf->Write(&m_dYvel) == 1)
                                                                    {
                                                                        if (pcf->Write(&m_dZvel) == 1)
                                                                        {
                                                                            ...
                                                                            {
                                                                                TRACE("RSprite::Save - Error writing "
                                                                                      "m_ulFlags\n");
                                                                                sReturn = FAILURE;
                                                                            }
                                                                        }
                                                                    ...
                                                                    {
                                                                        TRACE(
                                                                          "RSprite::Save - Error writing m_dYvel\n");
                                                                        sReturn = FAILURE;
                                                                    }
                                                                }
                                                                else
                                                                ...
                                                                if (pcf->Read(&m_dYacc) == 1)
                                                                {
                                                                    if (pcf->Read(&m_dZacc) == 1)
                                                                    {
                                                                        if (pcf->Read(&m_dXvel) == 1)
                                                                        {
                                                                                                  ...
                                                                                                  &m_sHotSpotY) == 1)
                                                                                            {
                                                                                                    ...
                                                                                                    1)
                                                                                                {
                                                                                                      ...
                                                                                                      1)
                                                                                                    {
                                                                                                        ...
                                                                                                        {
                                                                                                            sReturn =
                                                                                                              SUCCESS; // No image to read, just continue
                                                                                                        }
                                                                                                    }
                                                                                                    else
                                                                                                    {
                                                                            ...
                                                                            {
                                                                                TRACE("RSprite::Load - Error reading "
                                                                                      "m_dYvel\n");
                                                                                sReturn = FAILURE;
                                                                            }
                                                                        }
                                                                    ...
                                                                    {
                                                                        TRACE(
                                                                          "RSprite::Load - Error reading m_dZacc\n");
                                                                        sReturn = FAILURE;
                                                                    }
                                                                }
                                                                else
...
//
//*****************************************************************************
short RSprite::DoRegionsCollide(short /*sThisRegionType*/, short /*sOtherRegionType*/, RSprite * /*pSprite*/)
{
    short bCollision = 0;
