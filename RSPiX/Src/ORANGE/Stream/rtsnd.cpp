...
//
//////////////////////////////////////////////////////////////////////////////
short CRtSnd::Use(UCHAR *puc, long lSize, USHORT usType, UCHAR ucFlags, long lTime)
{
    ...
    if (ucFlags & RT_FLAG_INIT)
    {
        ...
        if (psndhdr->mix.OpenChannel(psndhdr->lSamplesPerSec, psndhdr->sBitsPerSample, psndhdr->sNumChannels) == 0)
        {
...
//
//////////////////////////////////////////////////////////////////////////////
void *CRtSnd::MixCall(USHORT usMsg, void *pData, ULONG *pulBufSize, ULONG ul_psndhdr)
{
...
//
//////////////////////////////////////////////////////////////////////////////
short CRtSnd::UseStatic(UCHAR *puc, long lSize, USHORT usType, UCHAR ucFlags, long lTime, long l_pRtSnd)
{
