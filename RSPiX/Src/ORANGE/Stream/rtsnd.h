...
class CRtSnd
{
  ...
  protected: // Internal methods.
    ...
    static short UseStatic(UCHAR *puc, long lSize, USHORT usType, UCHAR ucFlags, long lTime, long l_pRtSnd);

    // Callback for mixer.
    // Returns new buffer to play or NULL if none.
    static void *MixCall(USHORT usMsg, void *pData, ULONG *pulBufSize, ULONG ul_psndhdr);
