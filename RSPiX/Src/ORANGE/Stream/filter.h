...
typedef UCHAR *(*ALLOC_FILTERFUNC)(long lSize, USHORT usType, UCHAR ucFlags, long lUser);
...
typedef void (*FREE_FILTERFUNC)(UCHAR *puc, USHORT usType, UCHAR ucFlags, long lUser);

// This type is used to pass the copied chunk to the user ready to be used.
typedef void (*USE_FILTERFUNC)(UCHAR *puc, long lSize, USHORT usType, UCHAR ucFlags, long lTime, long lUser);
...
class CFilter
{
  ...
  public: // Methods.
    void SetFilter(ULONG ulFilterMask) { m_ulFilter = ulFilterMask; }
  ...
  public: // Querries.
    ...
    ULONG GetFilter(void) { return m_ulFilter; }
  ...
  protected: // Internal methods.
    ...
    PRTCHUNK AddChunk(long lSize, USHORT usType, UCHAR ucFlags, long Id, long lTime);
