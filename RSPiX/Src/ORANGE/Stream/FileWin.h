...
class CFileWin
{
  ...
  public: // Methods.
    ...
    void SetInputInterval(long lInputInterval) { m_lInputInterval = lInputInterval; }
    ...
    // Clear status flag.
    void ClearStatus(void) { m_usStatus = 0; }
  ...
  public: // Querries.
    ...
    PPANE GetCurPane(void) { return &m_paneUser; }
    ...
    USHORT GetStatus(void) { return m_usStatus; }

    // Get time based on user handler or blue.
    long GetTime(void) { return (m_fnTime == NULL ? Blu_GetTime() : (*m_fnTime)(m_lTimeUser)); }
