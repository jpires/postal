...
//
//////////////////////////////////////////////////////////////////////////////
short CRtFlic::Use(UCHAR *puc, long lSize, USHORT usType, UCHAR ucFlags, long lTime)
{
    ...
    else
    {
        ...
        if (pflxhdr->pImage != NULL)
        {
            ...
            if (sDecompress == TRUE)
            {
                if (CRamFlx::DoReadFrame(pflxhdr->pImage,
                                         &file,
...
//
//////////////////////////////////////////////////////////////////////////////
short CRtFlic::UseStatic(UCHAR *puc, long lSize, USHORT usType, UCHAR ucFlags, long lTime, long l_pRtFlic)
{
