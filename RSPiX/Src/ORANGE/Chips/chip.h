...
class CChip
{
  ...
  public: // Methods.
    ...
    void SetChipImage(RImage *pim) { m_pimChip = pim; }

    // Set background BKD for all chips.
    static void SetBackground(RImage *pimbkd) { ms_pimView = pimbkd; }

    // Set stack image for all chips.
    static void SetStackImage(RImage *pim) { ms_pimStack = pim; }
    ...
    void SetStackable(short sStackable) { m_sStackable = sStackable; }
    ...
    void SetSize(short sNum) { m_sNumChips = sNum; }

  public: // Querries.
    // Get the sprite for this chip.
    RImage *GetChipImage(void) { return m_pimChip; }

    // Returns pointer to background BKD for all chips.
    static RImage *GetBackground(void) { return ms_pimView; }

    // Returns pointer to stack image for all chips.
    static RImage *GetStackImage(void) { return ms_pimStack; }

    // TRUE if sliding, FALSE otherwise.
    short IsSliding(void) { return m_sSliding; }
    ...
    short GetSize(void) { return m_sNumChips; }
