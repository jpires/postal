...
class RString
{
  ...
  public:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    long GetSize(void) const { return m_lBufSize; }
  ...
  public:
    ...
    // space)
    ////////////////////////////////////////////////////////////////////////////////
    long GetLen(void) const { return m_lStrLen; }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    char operator[](long lPos) const { return GetAt(lPos); }
...
// is, to reiterate, very clumsy.
  ...
  public:
    ...
    RString(void) { Construct(0); }

    // Create empty string with minimum buffer size (see Grow())
    RString(long lMinimumSize) { Construct(lMinimumSize); }
