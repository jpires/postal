...
class RMeter : public RDlg
{
  ...
  public: // Methods.
    ...
    void StartPeriod(void) { m_lStartPeriod = rspGetMilliseconds(); }
    ...
    void NextType(void)
    {
        SetType((DisplayType)((m_dtType + 1) % NumDisplayTypes), m_itType);
        Compose();
    }
  ...
  protected: // Internal functions.
    ...
    static void BtnCall(RGuiItem *pgui) { ((RMeter *)pgui->m_ulUserInstance)->NextType(); }
