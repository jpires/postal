...
inline void rspfrSet(RFracS16 &fr, long lVal)
{
    fr.set = lVal;
}
...
//
inline void rspfrAdd32(long &lVal, long &lNum, long &lDel, long &lInc, long &lDen, long &lAdd, PROPER, POSITIVE)
{
    lNum += lInc;
    if (lNum >= lDen)
    {
...
// all values are signed, including lInc & lDel ...
//
inline void rspfrAdd32(long &lVal, long &lNum, long &lDel, long &lInc, long &lDen, long &lAdd, IMPROPER, POSITIVE)
{
    lVal += lDel;
    lNum += lInc;
    if (lNum >= lDen)
...
//
inline void rspfrAdd32(long &lVal, long &lNum, long &lDel, long &lInc, long &lDen, long &lAdd, PROPER, NEGATIVE)
{
    lNum += lInc;
    if (lNum < 0)
    {
...
// all values are signed, including lInc & lDel & lAdd ...
//
inline void rspfrAdd32(long &lVal, long &lNum, long &lDel, long &lInc, long &lDen, long &lAdd, IMPROPER, NEGATIVE)
{
    lVal += lDel;
    lNum += lInc;
    if (lNum < 0)
...
//
inline void rspfrAdd32(long &lVal, long &lNum, long &lDel, long &lInc, long &lDen, long &lPixSize)
{
    lVal += lDel;
    lNum += lInc;
    if (lNum < 0)
