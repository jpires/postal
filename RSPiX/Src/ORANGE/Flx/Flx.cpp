...
//
///////////////////////////////////////////////////////////////////////////////
short CFlx::Open(char *pszFileName,      // Full path and filename of flic file
...
//
///////////////////////////////////////////////////////////////////////////////
short CFlx::Create(char *pszFileName,      // Full path and filename of flic file
...
//
///////////////////////////////////////////////////////////////////////////////
short CFlx::ReadFrame(short sFrameNum,   // Frame number to be read
...
//
///////////////////////////////////////////////////////////////////////////////
short CFlx::ReadNextFrame(FLX_BUF *pbufRead) // Buffer for frame being read
{
    short sError = 0;
...
//
///////////////////////////////////////////////////////////////////////////////
short CFlx::WriteNextFrame(FLX_BUF *pbufWrite) // Buffer of frame to be written
{
    short sError = 0;
...
//
///////////////////////////////////////////////////////////////////////////////
short CFlx::WriteFirstFrame(FLX_BUF *pbufWrite) // Buffer of frame to be written
{
...
//
///////////////////////////////////////////////////////////////////////////////
short CFlx::WriteNextFrame(FLX_BUF *pbufWrite, // Buffer of next frame to be written
...
//
///////////////////////////////////////////////////////////////////////////////
short CFlx::WriteFinish(FLX_BUF *pbufFirst, // Buffer of first frame that was written or NULL
