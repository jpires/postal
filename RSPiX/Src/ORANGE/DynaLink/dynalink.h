...
#define LINKINSTANTIATE(FunctionTypedef, FriendClass, MaxElements)                                                     \
    FunctionTypedef CDynaLink<FunctionTypedef, FriendClass, MaxElements>::ms_afp[MaxElements] = {                      \
        NULL,                                                                                                          \
    }
...
#define LINKLATE(FunctionTypedef, FriendClass, MaxElements, pUserFunc, lUserFuncIndex)                                 \
    static CDynaLink<FunctionTypedef, FriendClass, MaxElements> dl##FunctionTypedef##lUserFuncIndex(pUserFunc,         \
                                                                                                    lUserFuncIndex)
...
// Typedefs.
//////////////////////////////////////////////////////////////////////////////
template<class FUNCTYPEPTR, class FRIEND, long lMax>
class CDynaLink
{
  public:
