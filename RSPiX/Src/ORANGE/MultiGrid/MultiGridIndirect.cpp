...
short RMultiGridIndirect::ms_asColorToPlane[MGI_MAX_PLANES] = { 1,   2,   4,    8,    16,   32,   64,   128,
...
// For Debugging
void RMultiGridIndirect::DumpPalette(RImage *pimDst,
                                     short sSrcX,
                                     short sSrcY,
                                     short sDstX,
                                     short sDstY,
...
short RMultiGridIndirect::Alloc(short sW, short sH, short sMaxPlanes, short sTileW, short sTileH)
{
    ASSERT(!m_pucPalette);
...
short RMultiGridIndirect::AddFSPR1(RImage *pimSrc, short sLogX, short sLogY, UCHAR ucVal, short sMaxW, short sMaxH)
{
    ASSERT(pimSrc);
    ...
    //--------------------------------------------
    // 1) clear the buffer
    rspRect(UCHAR(0), m_pimBuffer, 0, 0, m_pimBuffer->m_sWidth, m_pimBuffer->m_sHeight);
...
void RMultiGridIndirect::TileOR(UCHAR ucKey,
                                USHORT usValueOR,
                                short sDstX,
                                short sDstY,
