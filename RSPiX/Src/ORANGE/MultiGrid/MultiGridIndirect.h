...
class RMultiGridIndirect
{
  public:
    ...
    //
    void DumpPalette(RImage *pimDst, short sSrcX, short sSrcY, short sDstX, short sDstY, short sW, short sH);
    ...
    RMultiGridIndirect() { Clear(); }

    ~RMultiGridIndirect() { Free(); }
    ...
    void CacheTile(RImage *pimSrc, short sSrcX, short sSrcY)
    {
        ...
        rspBlit(pimSrc, m_pimTempTile, sSrcX, sSrcY, 0, 0, m_sTileW, m_sTileH, NULL, &rrect);
    }
    ...
    //
    short AddFSPR1(RImage *pimSrc, short sX, short sY, UCHAR ucVal, short sMaxW = 0, short sMaxH = 0);
