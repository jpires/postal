...
class RBList
{
  ...
  public:
    ...
    short Remove(void) { return Remove(m_pnCurrent); }

    // Remove a node from the list.
    short Remove(LISTDATA ldRem) { return Remove(Find(ldRem)); }
  ...
  public:
    RBList(short sInitialize = TRUE) // If this flag is FALSE, no initialization
