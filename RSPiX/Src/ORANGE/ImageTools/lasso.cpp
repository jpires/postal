...
inline short suxRect( // Returns 0 on success, 1 if clipped out entirely.
...
///////////////////////////////////////////////////////////////////////////
template<class COLOR>
inline short EvalPixel(      // Returns TRUE if pixel is not clrDisjoin.
...
#endif // WIN32
  short
  rspLassoNext(                // Returns 0 if a polygon found,
        ...
        if (sRes == 0)
        {
            ...
            for (sY = 0; sY < sSrcH; sY++)
            {
                ...
                while (sFoundShape == FALSE)
                {
                    if (sX < sSrcW)
                    {
                        if (EvalPixel((COLOR *)pimSrc->m_pData,
                                      sX,
                                      sY,
                                      lPitch,
                                      sSrcX,
                    ...
                    do
                    {
                        ...
                        switch (u16Last & DIRMASK)
                        {
                            case DIRRIGHT:
                                ...
                                u16Last |= ((EvalPixel((COLOR *)pimSrc->m_pData,
                                                       (short)(sX + 1),
                                                       sY,
                                                       lPitch,
                                                       sSrcX,
                                              ...
                                              ? NEW10
                                              : NEW00) |
                                           ((EvalPixel((COLOR *)pimSrc->m_pData,
                                                       (short)(sX + 1),
                                                       (short)(sY + 1),
                                                       lPitch,
                                                       sSrcX,
