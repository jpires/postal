...
extern UCHAR
rspMatchColorRGB(long r, long g, long b, short sStart, short sNum, UCHAR *pr, UCHAR *pg, UCHAR *pb, long linc);
...
class RAlpha
{
  public:
    ...
    short CreateLightEffectRGB(UCHAR *pa,
                               UCHAR *pr,
                               UCHAR *pg,
                               UCHAR *pb,
                               long linc = 4,
...
class RMultiAlpha
{
  public:
    ...
    static short QueryFastMultiAlpha(short sNumSrcCol,
                                     short sNumDstCol,
                                     long lTotMem,
                                     long *plHeaderSize = NULL,
                                     long *plDataSize = NULL);

    // Create a FastMultiAlpha which MUST be freed BY the USER
    // USING the DeleteFastMultiAlpha command ising THIS MALPHA:
    UCHAR ***pppucCreateFastMultiAlpha(short sStartSrc,
    ...
    //
    short CreateLayer(short sLayerNumber, double dOpacity, short sPalStart = 0, short sPalLen = 256);
...
class RFastMultiAlphaWrapper
{
  public:
    ...
    short Attach(UCHAR ***pppucFMA, short sStartSrc, short sNumSrc, short sStartDst, short sNumDst, short sNumLayers);
