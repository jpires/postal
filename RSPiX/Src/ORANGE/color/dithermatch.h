...
//
extern short rspDither(RImage *pimSrc,  // MUST BE 24-bit!
...
// smaller numbers can be used for slower machines.
//
extern short rspSimpleMap(RImage *pimSrc,  // MUST BE 24-bit!
                          RImage *pimDst,  // MUST be 8-bit
                          short sStartMap, // palette index
                          short sNumMap,   // # of colors
                          UCHAR *pRed,     // Palette to match to
...
//==============================================
//
extern short rspDither(long lBackR, // Don't dither to this color!
                       long lBackG,
                       long lBackB,
