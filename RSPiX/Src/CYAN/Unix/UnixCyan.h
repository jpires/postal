...
extern void rspSetCursor(RCursor *pCursor); // In:  Pointer to RCursor
...
extern void rspUnloadCursor(RCursor *pCursor); // In:  RCursor to unload
...
extern void rspSetQuitStatus(short sStatus); // In:  New status (TRUE or FALSE)
...
extern void rspSetQuitStatusFlags(long lModifiers); // In:  Modifier key flags (RSP_GKF_*)
