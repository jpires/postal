...
#define CD_DRIVE_CHANGE_MESSAGE                                                                                        \
    "If you added (or removed) a drive to your system after the game was installed, try putting the CD in another "    \
    "drive (if you have more than one) or re-install the game."

#define ADVANCED_USERS_CHANGE_PATH                                                                                     \
    "For advanced users: Instead of re-installing you can edit the '" PREFS_FILE                                       \
    "' file and change the '%s' entry in the [%s] section to the correct drive letter."
...
extern char g_pszBadBlueInit[] = "A system incompatibility has been detected."
                                 "\n\n"
#ifdef WIN32
...
extern char g_pszVideoChangeDepthError[] = "The required display settings (%s) could not be set properly."
                                           "\n\n"
...
extern char g_pszAudioModeNotSupportedError_s[] = "The audio mode (%s) could not be set properly."
                                                  "\n\n"
...
extern char g_pszAudioVanillaModeNotSupportedError_s[] = "The audio mode (%s) could not be set properly."
                                                         "\n\n"
                                                         "The audio device does not support this mode."
                                                         "\n\n"
                                                         "If you want to continue without audio, choose 'Yes'."
...
extern char g_pszPrefOpenError[] = "The preference file '" PREFS_FILE "' could not be opened."
                                   "\n\n"
                                   "See code A100 in " APP_NAME " Help for more information.";

extern char g_pszPrefReadError[] = "An error occurred while reading from '" PREFS_FILE "'."
                                   "\n\n"
                                   "See code A101 in " APP_NAME " Help for more information.";

extern char g_pszPrefWriteError[] = "An error occurred while saving to '" PREFS_FILE "'."
                                    "\n\n"
                                    "Any settings that you may have made will not be saved."
                                    "\n\n"
                                    "See code A102 in " APP_NAME " Help for more information.";

extern char g_pszPrefReadOnly[] = "The file '" PREFS_FILE "' is set to 'READ-ONLY'."
                                  "\n\n"
                                  "Any settings that you may have made will not be saved."
                                  "\n\n"
                                  "See code A103 in " APP_NAME " Help for more information.";

extern char g_pszTitleError[] = "An error occurred during the title sequence."
                                "\n\n"
                                "See code A104 in " APP_NAME " Help for more information.";

extern char g_pszCantFindAssets[] = "One or more required files could not be found."
                                    "\n\n" CD_DRIVE_CHANGE_MESSAGE "\n\n"
                                    "See code A105 in " APP_NAME " Help for more information.";

extern char g_pszWrongCD[] = "The original Postal CD is not in the drive it was installed from."
                             "\n\n"
                             "The CD in the drive does not appear to be the original Postal CD."
                             "\n\n"
                             "Please insert the original Postal CD and click on Retry.";

extern char g_pszPromptForOriginalCD[] = "Please make sure the original Postal CD\n"
                                         "is in the drive it was installed from.";

extern char g_pszNotOnCDROM[] = "Please insert the " APP_NAME " CD into the drive you used to install it."
                                "\n\n" CD_DRIVE_CHANGE_MESSAGE "\n\n"
                                "See code A106 in " APP_NAME " Help for more information.";

extern char g_pszGeneralError[] = "An error has occurred.  This application cannot proceed."
                                  "\n\n"
                                  "See code A107 in " APP_NAME " Help for more information.";

extern char g_pszBadPath_s_s[] = "One or more file locations for the game are invalid."
                                 "\n\n" CD_DRIVE_CHANGE_MESSAGE "\n\n" ADVANCED_USERS_CHANGE_PATH "\n\n"
                                 "See code A108 in " APP_NAME " Help for more information.";

extern char g_pszBadCDPath_s_s[] = "Make sure the " APP_NAME " CD is in the drive you used to install it."
                                   "\n\n" CD_DRIVE_CHANGE_MESSAGE "\n\n" ADVANCED_USERS_CHANGE_PATH "\n\n"
                                   "See code A108 in " APP_NAME " Help for more information.";

extern char g_pszCannotOpenSoundFiles_s_s[] = "Your audio hardware supports %s, but the " APP_NAME
                                              " file(s) associated with that "
                                              "sound format were not installed."
                                              "\n\n"
                                              "See code A109 in " APP_NAME " Help for more information.";

extern char g_pszNoSoundFiles[] = "There is no sound file installed."
                                  "\n\n"
                                  "Please run " APP_NAME " Setup and choose a sound option."
                                  "\n\n"
                                  "See code A110 in " APP_NAME " Help for more information.";

extern char g_pszAssetsMissingError[] = "One or more files needed by the editor could not be found.";

extern char g_pszSaveFileQuery[] = "Save file before this operation?";

extern char g_pszSaveDemoTitle[] = "Save Demo";

extern char g_pszSaveGameTitle[] = "Choose a name for your saved game";

extern char g_pszSaveGameErrorTitle[] = "Error saving file";

extern char g_pszSaveGameErrorText[] = "Your game could not be saved.  Check to see if your disk is full.";

extern char g_pszLoadGameTitle[] = "Choose the game you wish to restore";

extern char g_pszFileOpenError_s[] = "Unable to open the file '%s'."
                                     "\n\n"
                                     "The file may be missing or corrupted, or you may not have permission to open it.";

extern char g_pszFileReadError_s[] = "An error has occurred while reading from the file '%s'."
                                     "\n\n"
                                     "The file may be corrupted, or you may not have permission to access it.";

extern char g_pszFileWriteError_s[] = "An error has occurred while writing to the file '%s'."
                                      "\n\n"
                                      "The file may be corrupted, or you may not have permission to write to it.";

extern char g_pszDispenserNoDispenseeTypeChosen[] = "You must choose a dispensee type or Cancel.";

extern char g_pszGenericBrowseFor_s_Title[] = "Browse for %s";

extern char g_pszGenericMustBeRelativePath_s[] = "You must choose a file below path \"%s\".\n";

extern char g_pszDontDropYourselfMORON[] = "You don't really want to drop yourself!!\n";
...
extern char g_pszPlayOneRealmOnlyMessage[] = "This version of " APP_NAME " only allows you to play the"
                                             "\n"
...
extern char *g_apszSoundCategories[] = { "GENERAL", "SOUNDTRACK", "WEAPONS",  "FEEDBACK", "DESTRUCTION",
                                         "AMBIENT", "DEMON",      "SHOUTING", "PAIN",     "SUFFERING" };

#elif LOCALE == GERMAN

extern char *g_apszSoundCategories[] = {
    "ALLGEMEIN", "SOUNDTRACK", "WAFFEN",   "FEEDBACK",  "ZERSTORUNG",
    "UMGEBUNG",  "DAMON",      "GESCHREI", "SCHMERZEN", "LEIDEN",
};

#elif LOCALE == FRENCH

extern char *g_apszSoundCategories[] = {
    "GENERAL",  "PISTE MUSICALE", "ARMES", "FEED-BACK", "DESTRUCTION",
    "AMBIANTE", "DEMON",          "CRIS",  "DOULEUR",   "SOUFFRANCE",
};
