...
class CSoundCatalogue
{
  public:
    CSoundCatalogue(SampleMasterID *psmID)
    {
        ...
        {
            ms_ppsmNameList = (SampleMasterID **)calloc(sizeof(SampleMasterID *), MAX_SOUNDS);
            ms_sCurPos = 0;
        }
...
//////////////////////////////////////////////////////////////////////////////
short GetCategoryVolume(SampleMaster::SoundCategory eType = SampleMaster::Unspecified);
