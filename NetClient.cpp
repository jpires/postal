...
// Startup
////////////////////////////////////////////////////////////////////////////////
void CNetClient::Startup(RSocket::BLOCK_CALLBACK callback) // In:  Blocking callback
{
            ...
            case WaitForLoginResponse:
                ...
                switch (msg.msg.nothing.ucType)
                {
                    ...
                    case NetMsg::LOGIN_ACCEPT:
                        ...
                        if ((msg.msg.loginAccept.ulVersion >= CNetMsgr::MinVersionNum) &&
                        ...
                        else
                        {
                            ...
                            if ((msg.msg.loginAccept.ulVersion & CNetMsgr::MacVersionBit) ^
                            ...
                            TRACE(
                              "CNetClient::Update(): Error trying to login to server -- unsupported version number!\n");
                        }
                        break;
            ...
            case WaitForJoinResponse:
                ...
                switch (msg.msg.nothing.ucType)
                {
                    ...
                    case NetMsg::JOIN_ACCEPT:
                    {
                        ...
                        unsigned short usPeerPort = RSocket::GetAddressPort(&m_addressServer) +
                                                    Net::FirstPeerPortOffset + m_id;
                        ...
                        if (m_socketPeers.Open(usPeerPort, RSocket::typDatagram, RSocket::optDontBlock, m_callback) ==
                            0)
                        {
...
////////////////////////////////////////////////////////////////////////////////
void CNetClient::GetMsg(NetMsg *pmsg) // Out: Message is returned here
{
                ...
                case NetMsg::DROPPED:
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            msg.msg.dropAck.seqLastDropeeInput = (Net::SEQ)(m_aPeers[id].m_netinput.FindFirstInvalid() -
                                                                            (Net::SEQ)1);
...
////////////////////////////////////////////////////////////////////////////////
void CNetClient::SendMsg(NetMsg *pmsg,             // In:  Message to send
...
////////////////////////////////////////////////////////////////////////////////
void CNetClient::SendChat(const char *pszText) // In:  Text to send
{
    if (m_state == Joined)
    {
...
////////////////////////////////////////////////////////////////////////////////
void CNetClient::SendText(const char *pszText) // In:  Text to send
{
    if (m_state == Joined)
    {
        // Create chat message.  For now, we set the mask to include everyone.  In
...
// Send realm status
////////////////////////////////////////////////////////////////////////////////
void CNetClient::SendRealmStatus(bool bReady)
{
    NetMsg msg;
    if (bReady)
    {
...
////////////////////////////////////////////////////////////////////////////////
void CNetClient::SetLocalInput(UINPUT input)
{
...
////////////////////////////////////////////////////////////////////////////////
void CNetClient::SetHaltFrame(Net::SEQ seqHalt)
{
