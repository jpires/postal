...
{
    void operator()(void *pT) { delete (T *)pT; }
};
...
{
    virtual short operator()(void * /*pT*/, RFile * /*pfile*/) { return -1; } // generic version should never be called!
};

template<class T>
struct LoadResFunc : GenericLoadResFunc
{
    short operator()(void *pT, RFile *pfile) { return rspAnyLoad((T *)pT, pfile); }
};
...
class RResMgr
{
  ...
  public:
    ...
    void TraceUncachedLoads(bool bShow) { m_bTraceUncachedLoads = bShow; }
    ...
    // the batch files.
    short CreateSakBatch(RString strBatchFile) { return Statistics(strBatchFile); }
    ...
    char *GetBasePath(void) { return (char *)m_strBasepath; }
