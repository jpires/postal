...
class CTreeListNode
{
  ...
  public:
    ...
    void Add(Node *pn) // In:  Node to add in the tree and list
    {
...
class CBouy : public CThing
{
  ...
  public:
    ...
    bool Visible(void) { return ((m_sprite.m_sInFlags & CSprite::InHidden) == 0); }

    // Toggle the show/hide flag
    static void Show(void) { ms_bShowBouys = true; }

    // Toggle the show/hide flag
    static void Hide(void) { ms_bShowBouys = false; }
