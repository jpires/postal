        ...
        switch (m_state)
        {
            ...
            case CFlag::State_Guard:
                if (m_pRealm->m_smashatorium
                      .QuickCheckClosest(&m_smash, m_u32IncludeBits, m_u32DontcareBits, m_u32ExcludeBits, &pSmashed))
                {
                    ...
                    if (pSmashed->m_pThing->GetClassID() == CDudeID)
                    {
                        ...
                        // Feedback.
                        PlaySample(g_smidDemonYes2, SampleMaster::Demon, DistanceToVolume(m_dX, m_dY, m_dZ, 250));
                    }
                }
