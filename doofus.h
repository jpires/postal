...
class CDoofus : public CCharacter
{
  ...
  public:
    ...
    // enemies.
    virtual CWeapon *ShootWeapon(CSmash::Bits bitsInclude = CSmash::Character,
    ...
    virtual SampleMaster::SoundInstance PlaySoundWrithing(long *plDuration) // Out:  Duration of sample, if not NULL.
    {
        if (plDuration != NULL)
        {
            *plDuration = 0;
