...
class CGrip
{
  ...
  public:
    ...
    void SetCamera(CCamera *pCamera); // In:  Camera to control

    // Set tracking parameters
    void SetParms(short sZoneR,         // In:  Zone radius
    ...
    void ResetTarget(short sTargetX, // In:  Target's x coord
    ...
    void TrackTarget(short sTargetX, // In:  Target's x coord
                     short sTargetY, // In:  Target's y coord
                     short sTargetR) // In:  Target's radius
    {
    ...
    void KeepInside(short sTargetX, // In:  Target's center x coord
