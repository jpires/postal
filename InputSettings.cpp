...
CInputSettings::InputInfo CInputSettings::ms_ainputinfoOld[CInputSettings::NumInputFunctions] = {
    // Description			Save Name			Default Key			Default Mouse Button(s)			Default Joy
    // Button(s)
    //	===========			===========			===========			======================= =====================
    {
      "Turn Left",
...
//////////////////////////////////////////////////////////////////////////////
short CInputSettings::LoadPrefs(RPrefs *pPrefs)
{
    short sResult = 0;
    ...
    for (i = 0; i < NumInputFunctions; i++)
    {
        pPrefs->GetVal("Keys", ms_ainputinfo[i].pszSaveName, g_apszKeyDescriptions[m_asPlayKeys[i]], szDescriptor);
...
//////////////////////////////////////////////////////////////////////////////
short CInputSettings::SavePrefs(RPrefs *pPrefs)
{
    ...
    for (i = 0; i < NumInputFunctions; i++)
    {
        pPrefs->SetVal("Keys", ms_ainputinfo[i].pszSaveName, g_apszKeyDescriptions[m_asPlayKeys[i]]);

        pPrefs->SetVal("Mouse",
                       ms_ainputinfo[i].pszSaveName,
                       g_apszMouseButtonDescriptions[MouseBitfieldToIndex(m_asPlayMouseButtons[i])]);

        pPrefs->SetVal("Joystick",
                       ms_ainputinfo[i].pszSaveName,
                       g_apszJoyButtonDescriptions[JoyBitfieldToIndex(m_asPlayJoyButtons[i])]);
    }
...
//////////////////////////////////////////////////////////////////////////////
short CInputSettings::LoadGame(RFile *pFile)
{
    return 0;
}
...
//////////////////////////////////////////////////////////////////////////////
short CInputSettings::SaveGame(RFile *pFile)
{
    return 0;
}
...
//////////////////////////////////////////////////////////////////////////////
short CInputSettings::PreDemo(RFile *pFile)
{
    // Store current keys?
...
//////////////////////////////////////////////////////////////////////////////
short CInputSettings::PostDemo(RFile *pFile)
{
    // Restore user keys?
