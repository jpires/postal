...
class CCrawler
{
  ...
  public:
    ...
    // Setup crawler
    ////////////////////////////////////////////////////////////////////////////////
    void Setup(short sNum,       // In:  Number of Nub's in array
  ...
  protected:
      ...
      short sz)   // In:  Z position.
    {
        ...
        if (psl2d != NULL)
        {
            m_prealm->Map3Dto2D(sx, sy, sz, &(psl2d->m_sX2), &(psl2d->m_sY2));
