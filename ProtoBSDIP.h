...
class RProtocolBSDIP : public RSocket::RProtocol
{
    ...
    typedef struct tAddressIP
    {
      public:
        ...
        bool operator==(const tAddressIP &rhs) const
        {
            ...
            if ((prototype == rhs.prototype) && (lAddressLen == rhs.lAddressLen) &&
                (address.sin_family == rhs.address.sin_family) && (address.sin_port == rhs.address.sin_port) &&
  ...
  public:
    ...
    virtual void SetCallback(RSocket::BLOCK_CALLBACK callback);
