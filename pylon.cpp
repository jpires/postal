                    ...
                    if (pSelection)
                    {
                        switch (pSelection->m_lId)
                        {
                                /*
                                                            ...
                                                            case 21:
                                                                pSecondaryGui =
                                   RGuiItem::LoadInstantiate(FullPathVD("res/editor/bouy_pop.gui")); if (pSecondaryGui)
                                                                {
                                                                    SetText(pSecondaryGui, 3, m_msg.msg_Popout.sAngle);
                                                                    SetText(pSecondaryGui, 4,
                                   m_msg.msg_Popout.sDistance); sResult = DoGui(pSecondaryGui); if (sResult == 1)
                                                                    {
                                                                        // Get results back and store in message
                                                                        m_msg.msg_Popout.sAngle =
                                   pSecondaryGui->GetVal(3); m_msg.msg_Popout.sDistance = pSecondaryGui->GetVal(4);
                                                                    }
                                                                }
                                                                break;
                                */
                            ...
                            case 21:
                                ...
                                if (pSecondaryGui)
                                {
                                    ...
                                    if (sResult == 1)
                                    {
                                        ...
                                        CPylon *pPylon;
                                        if (m_pRealm->m_idbank.GetThingByID((CThing **)&pPylon,
                                                                            m_msg.msg_Popout.u16UniquePylonID) == 0)
                                        {
                            ...
                            case 23:
                                ...
                                if (pSecondaryGui)
                                {
                                    ...
                                    if (sResult == 1)
                                    {
                                        ...
                                        m_msg.msg_ShootCycle.u16UniquePylonID = GetPylonUniqueID(
                                          m_msg.msg_ShootCycle.ucIDNext);
                                        CPylon *pPylon;
                                        if (m_pRealm->m_idbank.GetThingByID((CThing **)&pPylon,
                                                                            m_msg.msg_ShootCycle.u16UniquePylonID) == 0)
                                        {
