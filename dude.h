...
class CDude : public CCharacter
{
  ...
  public:
    ...
    short GetHealth() { return m_stockpile.m_sHitPoints; };
  ...
  protected:
    ...
    void DropAllFlags(GameMessage *pmsg); // In:  Message to pass to flags.
};
