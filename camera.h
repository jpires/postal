...
class CCamera
{
  ...
  public:
    ...
    // Set camera's scene
    void SetScene(CScene *pScene); // In:  Scene to take picture of

    // Set camera's hood
    void SetHood(CHood *pHood); // In:  Hood to use for camera control

    // Set camera's view of the scene
    void SetView(short sSceneViewX, // In:  View's upper left x (in scene coords)
    ...
    void SetViewPos(short sSceneViewX,  // In:  View's upper left x (in scene coords)
                    short sSceneViewY); // In:  View's upper left y (in scene coords)

    // Set camera's view size (assumes the view's position will be or was set separately)
    void SetViewSize(short sViewW,  // In:  View's width
                     short sViewH); // In:  View's height
    ...
    void SetFilm(RImage *pimFilm,   // In:  Film (where the picture ends up)
    ...
    void Snap(short sViewW,      // In:  View's width
              short sViewH,      // In:  View's height
