...
#define BUFQ_PREV(i) (((i) - (short)1) >= 0 ? ((i) - (short)1) : (QueueSize - (short)1))
  ...
  public:
    ...
    bool IsFull(void) { return BUFQ_NEXT(m_sPutPos) == m_sGetPos; }

    // Determine whether queue is empty
    bool IsEmpty(void) { return m_sGetPos == m_sPutPos; }

    // Determine whether we can Put() another byte
    bool CanPutByte(void) { return BUFQ_NEXT(m_sPutPos) != m_sGetPos; }

    // Determine whether we can Get() another byte
    bool CanGetByte(void) { return m_sGetPos != m_sPutPos; }
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void LockPutPtr(U8 **ppu8Put,  // Out: Pointer to which up to *plAmountAvail bytes can be put
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void ReleasePutPtr(long lBytes) // In:  Number of bytes written to locked pointer
    {
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void LockGetPtr(U8 **ppu8Get,  // Out: Pointer from which up to *plAmountAvail bytes can be gotten
    ...
    // This function is indiscriminant and will screw you if you lie!
    ///////////////////////////////////////////////////////////////////////////////
    void ReleaseGetPtr(long lBytes) // In:  Number of bytes that were gotten from locked pointer
    {
