...
class CCharacter : public CThing3d
{
  ...
  public:
    ...
    virtual // Overridden here.
      void
      Render(void); // Returns nothing.

    // Update object.
    virtual // Overridden here.
      void
      Update(void); // Returns nothing.
  ...
  public:
    ...
    virtual // Override to implement additional functionality.
      void
      ProcessMessage(       // Returns nothing.
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      void
      OnDrawBloodMsg(                      // Returns nothing.
    ...
    virtual // Override to implement additional functionality
            // Call base class to get default functionality
      void
      OnPutMeDownMsg(                      // Returns nothing
  ...
  public:
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      bool
      WhileBlownUp(void); // Returns true until state is complete.
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      bool
      WhileBurning(void); // Returns true until state is complete.
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      bool
      WhileHoldingWeapon(    // Returns true when weapon is released.
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      bool
      WhileRunOver(void); // Returns true until state is complete.
  ...
  public:
    ...
    void MakeBloody(short sDamage,      // In:  Damage to base carnage on.
    ...
    void BloodToBackground(short sAnimX2d,  // Position of animation in 2d.
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      CWeapon *
      PrepareWeapon(void); // Returns the weapon ptr or NULL.
    ...
    virtual // Override to implement additional functionality.
            // Call base class to get default functionality.
      CWeapon *
      ShootWeapon( // Returns the weapon ptr or NULL.
    ...
    inline short FindAngleTo(double dX, double dZ) { return rspATan((m_dZ - dZ), (dX - m_dX)); }
